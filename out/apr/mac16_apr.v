...
// Generated on 8/25/2026 at 7:44:13
// Library Name: mac16_ndm
// Block Name: mac16
// User Label: 
// Write Command: write_verilog /home/user/MAC16_work/out/apr/mac16_apr.v
...
LATLQX0P5H9R latch ( .D ( net699 ) , .GN ( CLK ) , .Q ( net702 ) ) ;
OR2X0P5H9R test_or ( .A ( EN ) , .B ( optlc_0 ) , .Y ( net699 ) ) ;
AND2X1P4H9R main_gate ( .A ( net702 ) , .B ( CLK ) , .Y ( ENCLK ) ) ;
endmodule
...
LATLQX0P5H9R latch ( .D ( net671 ) , .GN ( CLK ) , .Q ( net674 ) ) ;
OR2X0P5H9R test_or ( .A ( EN ) , .B ( optlc_0 ) , .Y ( net671 ) ) ;
AND2X1P4H9R main_gate ( .A ( net674 ) , .B ( CLK ) , .Y ( ENCLK ) ) ;
endmodule
...
LATLQX0P5H9R latch ( .D ( net671 ) , .GN ( CLK ) , .Q ( net674 ) ) ;
OR2X0P5H9R test_or ( .A ( EN ) , .B ( p0 ) , .Y ( net671 ) ) ;
AND2X1P4H9R main_gate ( .A ( net674 ) , .B ( CLK ) , .Y ( ENCLK ) ) ;
endmodule
...
LATLQX0P5H9R latch ( .D ( net553 ) , .GN ( CLK ) , .Q ( net556 ) ) ;
OR2X0P5H9R test_or ( .A ( EN ) , .B ( optlc_0 ) , .Y ( net553 ) ) ;
AND2X1H9R main_gate ( .A ( net556 ) , .B ( CLK ) , .Y ( ENCLK ) ) ;
endmodule
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s22_reg[9] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net741 ) , .R ( HFSNET_5 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c21_reg[7] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net736 ) , .R ( HFSNET_3 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c21_reg[9] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net736 ) , .R ( HFSNET_1 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c21_reg[16] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net736 ) , .R ( HFSNET_6 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s21_reg[7] ( .D ( n758 ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net731 ) , .R ( HFSNET_6 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c20_reg[3] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net741 ) , .R ( HFSNET_6 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c20_reg[5] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net741 ) , .R ( HFSNET_2 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c20_reg[7] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net741 ) , .R ( HFSNET_1 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c20_reg[11] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net721 ) , .R ( HFSNET_6 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c20_reg[18] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net721 ) , .R ( HFSNET_8 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s20_reg[11] ( .D ( n738 ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net721 ) , .R ( HFSNET_3 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_out/shift_reg_reg[14] ( .D ( n2264 ) , 
    .CK ( \u_mac16_top/u_out/net664 ) , .R ( HFSNET_24 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_out/shift_reg_reg[16] ( .D ( n2262 ) , 
    .CK ( \u_mac16_top/u_out/net664 ) , .R ( HFSNET_23 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/accum_reg_reg[22] ( 
    .D ( \u_mac16_top/u_mac/add_tmp_comb [22] ) , 
    .CK ( \u_mac16_top/u_mac/net682 ) , .R ( HFSNET_17 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s31_reg[23] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net751 ) , .R ( HFSNET_4 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c31_reg[23] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net756 ) , .R ( HFSNET_4 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c31_reg[21] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net756 ) , .R ( HFSNET_3 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c40_reg[23] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net786 ) , .R ( HFSNET_30 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s30_reg[9] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net761 ) , .R ( HFSNET_3 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s40_reg[1] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net781 ) , .R ( HFSNET_31 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c30_reg[21] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net756 ) , .R ( HFSNET_31 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c30_reg[18] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net756 ) , .R ( HFSNET_30 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c30_reg[16] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net756 ) , .R ( HFSNET_28 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c40_reg[12] ( .D ( n2278 ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net771 ) , .R ( HFSNET_28 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c30_reg[9] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net751 ) , .R ( HFSNET_32 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c30_reg[4] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net761 ) , .R ( HFSNET_29 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s40_reg[4] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net781 ) , .R ( HFSNET_28 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c23_reg[20] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net736 ) , .R ( HFSNET_31 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c41_reg[22] ( .D ( n2284 ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net786 ) , .R ( HFSNET_32 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c41_reg[23] ( .D ( n2283 ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net786 ) , .R ( HFSNET_31 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s41_reg[23] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net771 ) , .R ( HFSNET_4 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[15] ( .D ( ZBUF_2_6 ) , 
    .CK ( clk ) , .R ( HFSNET_32 ) , 
    .Q ( \u_mac16_top/u_mac/mult_result [15] ) ) ;
DFFRPQX0P5H9R \u_mac16_top/u_out/busy_reg ( .D ( n732 ) , .CK ( clk ) , 
    .R ( HFSNET_16 ) , .Q ( \u_mac16_top/u_out/busy ) ) ;
...
DFFRPQX0P5H9R \u_mac16_top/u_out/serial_out_reg ( 
    .D ( \u_mac16_top/u_out/N16 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
    .Q ( sum_out ) ) ;
DFFRPQX0P5H9R \u_mac16_top/u_out/out_ready_reg ( .D ( n730 ) , .CK ( clk ) , 
    .R ( HFSNET_16 ) , .Q ( out_ready ) ) ;
DFFRPQX0P5H9R \u_mac16_top/u_mac/carry_reg ( .D ( n729 ) , 
    .CK ( \u_mac16_top/u_mac/net688 ) , .R ( HFSNET_16 ) , .Q ( carry ) ) ;
...
DFFRPQX1H9R \u_mac16_top/u_mac/u_mul/r_s40_reg[9] ( 
    .D ( \u_mac16_top/u_mac/u_mul/s40 [9] ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net771 ) , .R ( HFSNET_31 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c41_reg[15] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net771 ) , .R ( HFSNET_3 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/accum_reg_reg[12] ( 
    ...
    .CK ( \u_mac16_top/u_mac/net682 ) , .R ( HFSNET_29 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/mac_result_shadow_reg[0] ( 
    .D ( \u_mac16_top/N92 ) , .CK ( \u_mac16_top/net622 ) , .R ( HFSNET_21 ) , 
...
DFFSQNX0P5H9R \u_mac16_top/fifo_rd_ptr_reg[0] ( .D ( n942 ) , 
    .CK ( \u_mac16_top/net622 ) , .SN ( HFSNET_26 ) , 
...
DFFSQNX0P5H9R \u_mac16_top/fifo_wr_ptr_reg[0] ( .D ( n939 ) , 
    .CK ( \u_mac16_top/net647 ) , .SN ( HFSNET_26 ) , 
...
DFFSQNX0P5H9R \u_mac16_top/op_fifo_wr_ptr_reg[0] ( .D ( n940 ) , .CK ( clk ) , 
    .SN ( HFSNET_26 ) , .QN ( \u_mac16_top/op_fifo_wr_ptr [0] ) ) ;
DFFRPQNX0P5H9R \u_mac16_top/result_fifo_reg[3][13] ( 
    .D ( \u_mac16_top/mac_result [13] ) , .CK ( \u_mac16_top/net595 ) , 
    .R ( HFSNET_18 ) , .QN ( n2343 ) ) ;
DFFSQNX1H9R \u_mac16_top/u_mac/u_mul/r_s40_reg[12] ( .D ( n938 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_s21_reg[10] ( .D ( n756 ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net731 ) , .R ( HFSNET_3 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/opB_reg_reg[4] ( .D ( n777 ) , 
    .CK ( \u_mac16_top/net564 ) , .R ( HFSNET_8 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/opA_reg_reg[7] ( .D ( n796 ) , 
    .CK ( \u_mac16_top/net570 ) , .R ( HFSNET_7 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/opA_reg_reg[9] ( .D ( n798 ) , 
    .CK ( \u_mac16_top/net570 ) , .R ( HFSNET_14 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c40_reg[5] ( 
    ...
    .CK ( \u_mac16_top/u_mac/u_mul/net786 ) , .R ( HFSNET_29 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[0] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N33 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
...
DFFRPQX1H9R \u_mac16_top/u_mac/u_mul/r_s41_reg[11] ( 
    .D ( \u_mac16_top/u_mac/u_mul/r_c31 [11] ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net771 ) , .R ( HFSNET_30 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[19] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N52 ) , .CK ( clk ) , .R ( HFSNET_17 ) , 
...
NAND2BX0P7H9R ctmTdsLR_1_88 ( .AN ( n1021 ) , .B ( n1022 ) , .Y ( n1024 ) ) ;
...
INVX0P5H9R U1077 ( .A ( \u_mac16_top/opA_reg [9] ) , .Y ( n2097 ) ) ;
INVX1H9R U1079 ( .A ( \u_mac16_top/opA_reg [8] ) , .Y ( n2107 ) ) ;
INVX0P7H9R U1082 ( .A ( \u_mac16_top/opB_reg [6] ) , .Y ( n2207 ) ) ;
OAI21X0P7H9R U1091 ( .A0 ( n1791 ) , .A1 ( n1799 ) , .B0 ( n1792 ) , 
    .Y ( n1767 ) ) ;
NOR2X1P4H9R U1096 ( .A ( n891 ) , .B ( n1116 ) , .Y ( n1551 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_146 ( .A ( n1147 ) , .B ( n1146 ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_c41 [21] ) , .Y ( n1186 ) ) ;
INVX0P7H9R ctmTdsLR_1_179 ( .A ( n1113 ) , .Y ( tmp_net43 ) ) ;
OAI31X0P5H9R ctmTdsLR_1_50 ( .A0 ( n1822 ) , .A1 ( n1811 ) , .A2 ( n1310 ) , 
    .B0 ( n1263 ) , .Y ( n852 ) ) ;
NAND2XBX0P7H9R ctmTdsLR_1_119 ( .BN ( n1551 ) , .A ( n1550 ) , .Y ( n1488 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_147 ( .A ( n1194 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c41 [22] ) , .C ( n1193 ) , .Y ( n1182 ) ) ;
OA211X0P7H9R ctmTdsLR_2_180 ( .A0 ( \u_mac16_top/u_mac/u_mul/r_s40 [8] ) , 
    .A1 ( \u_mac16_top/u_mac/u_mul/r_c40 [8] ) , .B0 ( n1108 ) , 
    .C0 ( tmp_net43 ) , .Y ( n1116 ) ) ;
...
NAND3X0P5H9R ctmTdsLR_1_181 ( .A ( n1504 ) , .B ( n1845 ) , 
    .C ( \u_mac16_top/schedule_active ) , .Y ( tmp_net44 ) ) ;
XNOR3X1P4H9R ctmTdsLR_1_160 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [12] ) , 
    .B ( ZBUF_17_8 ) , .C ( \u_mac16_top/u_mac/u_mul/r_s40 [12] ) , 
    .Y ( n1127 ) ) ;
...
NAND2X2H9R U1178 ( .A ( n1491 ) , .B ( n1490 ) , .Y ( n1530 ) ) ;
OAI21X0P5H9R U1185 ( .A0 ( n1683 ) , .A1 ( n1599 ) , .B0 ( n1598 ) , 
    .Y ( n1604 ) ) ;
OAI211X0P5H9R ctmTdsLR_1_155 ( .A0 ( n926 ) , .A1 ( n1507 ) , .B0 ( n1508 ) , 
    .C0 ( n1464 ) , .Y ( n1474 ) ) ;
...
AO211X0P5H9R U1227 ( .A1 ( \u_mac16_top/u_out/bits_left [1] ) , 
    ...
    .Z ( n936 ) ) ;
OAI21X0P5H9R U1230 ( .A0 ( n1742 ) , .A1 ( n1753 ) , .B0 ( n1743 ) , 
    .Y ( n1724 ) ) ;
NOR2X0P5H9R U1233 ( .A ( n1882 ) , .B ( n2062 ) , .Y ( n1963 ) ) ;
...
NOR2X0P5H9R U1302 ( .A ( \u_mac16_top/u_mac/last_prod [10] ) , 
    .B ( \u_mac16_top/u_mac/mult_result [10] ) , .Y ( n1051 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_822 ( .A ( n1871 ) , .B ( n1872 ) , .C ( n1873 ) , 
    .Y ( n1065 ) ) ;
XNOR2X0P5H9R ctmTdsLR_1_148 ( .A ( \u_mac16_top/u_mac/u_mul/r_c41 [16] ) , 
    .B ( ZBUF_54_10 ) , .Y ( tmp_net36 ) ) ;
...
OAI31X0P5H9R ctmTdsLR_2_182 ( .A0 ( n1847 ) , .A1 ( n1845 ) , 
    .A2 ( \u_mac16_top/schedule_active ) , .B0 ( tmp_net44 ) , .Y ( n2348 ) ) ;
...
XOR3X1H9R ctmTdsLR_2_149 ( .A ( n1157 ) , .B ( tmp_net36 ) , .C ( n1156 ) , 
    .Y ( n1167 ) ) ;
XNOR2X0P7H9R U1558 ( .A ( n1156 ) , .B ( ZBUF_54_10 ) , .Y ( n854 ) ) ;
XNOR3X1H9R ctmTdsLR_1_150 ( .A ( n882 ) , .B ( n1154 ) , .C ( n881 ) , 
    .Y ( n843 ) ) ;
XOR2X0P5H9R ctmTdsLR_1_151 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [18] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [18] ) , .Y ( tmp_net37 ) ) ;
...
BUFX0P7H9R ropt_h_inst_889 ( .A ( \u_mac16_top/u_mac/mult_result [12] ) , 
    .Y ( ropt_net_105 ) ) ;
NAND2X0P5H9R U1586 ( .A ( n1661 ) , .B ( n999 ) , .Y ( n1646 ) ) ;
AOI21X0P5H9R U1587 ( .A0 ( n1724 ) , .A1 ( n995 ) , .B0 ( n994 ) , 
    .Y ( n996 ) ) ;
XOR2X1H9R U1596 ( .A ( ZBUF_17_14 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [17] ) , .Y ( n935 ) ) ;
INVX0P7H9R U1612 ( .A ( n1073 ) , .Y ( n2146 ) ) ;
AOI21X0P5H9R U1613 ( .A0 ( n976 ) , .A1 ( n1717 ) , .B0 ( n975 ) , 
    .Y ( n977 ) ) ;
NAND2BX0P7H9R ctmTdsLR_1_89 ( .AN ( n1622 ) , .B ( n1623 ) , .Y ( n1625 ) ) ;
XOR2X0P7H9R U1628 ( .A ( ZBUF_101_7 ) , .B ( ZBUF_190_3 ) , .Y ( n867 ) ) ;
XOR2X0P5H9R U1635 ( .A ( n878 ) , .B ( \u_mac16_top/u_mac/u_mul/r_s41 [20] ) , 
    .Y ( n893 ) ) ;
CGENCONAX1H9R U1650 ( .A ( n2366 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c41 [20] ) , .CI ( n893 ) , 
    .CON ( n1187 ) ) ;
XOR3X1H9R ctmTdsLR_1_814 ( .A ( n1112 ) , .B ( ZBUF_50_13 ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_c40 [7] ) , .Y ( n1486 ) ) ;
XOR3X1H9R ctmTdsLR_2_152 ( .A ( tmp_net37 ) , .B ( n2365 ) , 
    .C ( tmp_net34 ) , .Y ( n1171 ) ) ;
OA21X1H9R ctmTdsLR_1_120 ( .A0 ( n1550 ) , .A1 ( n1553 ) , .B0 ( n1554 ) , 
    .Y ( n873 ) ) ;
NAND2XBX0P7H9R ctmTdsLR_1_52 ( .BN ( n1688 ) , .A ( n1689 ) , .Y ( n1691 ) ) ;
INVX0P5H9R U1673 ( .A ( n1810 ) , .Y ( n1315 ) ) ;
INVX0P5H9R U1676 ( .A ( n1015 ) , .Y ( n1630 ) ) ;
INVX0P5H9R gre_a_INV_23_inst_888 ( .A ( n1476 ) , .Y ( gre_a_INV_23_14 ) ) ;
...
OAI21X0P7H9R U1692 ( .A0 ( n1735 ) , .A1 ( n1749 ) , .B0 ( n1736 ) , 
    .Y ( n1717 ) ) ;
...
NOR2X0P5H9R ctmTdsLR_1_53 ( .A ( n1683 ) , .B ( n1054 ) , .Y ( tmp_net3 ) ) ;
OAI21X0P7H9R U1795 ( .A0 ( n1692 ) , .A1 ( n1020 ) , .B0 ( n1019 ) , 
    .Y ( n1025 ) ) ;
AOI21X0P7H9R U1796 ( .A0 ( n1630 ) , .A1 ( n1018 ) , .B0 ( n1017 ) , 
    .Y ( n1019 ) ) ;
OR2X1H9R ctmTdsLR_1_90 ( .A ( n1164 ) , .B ( n1163 ) , .Y ( n1490 ) ) ;
AOI2XB1X0P5H9R ctmTdsLR_1_91 ( .A1N ( n1692 ) , .A0 ( n1661 ) , 
    .B0 ( n1662 ) , .Y ( tmp_net17 ) ) ;
NOR2BX0P5H9R ctmTdsLR_1_121 ( .AN ( \u_mac16_top/u_mac/mult_valid ) , 
...
AO22X0P5H9R ctmTdsLR_1_125 ( .A0 ( n1757 ) , .A1 ( n1267 ) , .B0 ( n1276 ) , 
...
NAND4X1H9R ctmTdsLR_1_122 ( .A ( n1508 ) , .B ( \u_mac16_top/cal_done ) , 
    .C ( \u_mac16_top/fifo_count [1] ) , .D ( \u_mac16_top/fifo_count [0] ) , 
    .Y ( tmp_net30 ) ) ;
NAND3BX0P5H9R ctmTdsLR_2_123 ( .AN ( \u_mac16_top/cal_done ) , .B ( n1507 ) , 
    .C ( \u_mac16_top/fifo_count [2] ) , .Y ( tmp_net31 ) ) ;
...
AO22X0P5H9R ctmTdsLR_1_126 ( .A0 ( n991 ) , .A1 ( n1838 ) , .B0 ( n1757 ) , 
    .B1 ( n1010 ) , .Y ( \u_mac16_top/u_mac/add_tmp_comb [20] ) ) ;
XOR2X0P5H9R U1876 ( .A ( n1562 ) , .B ( n1561 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N41 ) ) ;
XNOR2X0P5H9R U1912 ( .A ( n1499 ) , .B ( n1498 ) , 
...
XNOR3X1H9R ctmTdsLR_1_153 ( .A ( n878 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [20] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_c41 [20] ) , .Y ( tmp_net38 ) ) ;
XOR2X0P5H9R U1977 ( .A ( n1514 ) , .B ( \u_mac16_top/u_out/bits_left [4] ) , 
    .Y ( n1373 ) ) ;
XNOR2X0P5H9R U1981 ( .A ( n1511 ) , .B ( \u_mac16_top/u_out/bits_left [2] ) , 
    .Y ( n1374 ) ) ;
ADDFX1H9R U1989 ( .A ( n1067 ) , .B ( n1066 ) , .CI ( n1065 ) , 
    .CO ( \u_mac16_top/u_mac/u_mul/c22 [15] ) , .S ( n770 ) ) ;
ADDFX1H9R U1990 ( .A ( n972 ) , .B ( n971 ) , .CI ( n970 ) , 
    .CO ( \u_mac16_top/u_mac/u_mul/c22 [14] ) , 
    .S ( \u_mac16_top/u_mac/u_mul/s22[13] ) ) ;
NAND2X0P5H9R ctmTdsLR_3_124 ( .A ( tmp_net30 ) , .B ( tmp_net31 ) , 
    .Y ( n2345 ) ) ;
AO22X0P5H9R ctmTdsLR_1_127 ( .A0 ( n1757 ) , .A1 ( n1247 ) , .B0 ( n1256 ) , 
...
OAI2XB1X0P5H9R U1997 ( .A1N ( n2380 ) , .A0 ( n1551 ) , .B0 ( n1550 ) , 
    .Y ( n1557 ) ) ;
AO22X0P5H9R ctmTdsLR_1_128 ( .A0 ( n1757 ) , .A1 ( n1299 ) , .B0 ( n1307 ) , 
...
XOR2X0P5H9R ctmTdsLR_2_92 ( .A ( tmp_net17 ) , .B ( n1667 ) , .Y ( n1669 ) ) ;
AO22X0P7H9R ctmTdsLR_1_129 ( .A0 ( n1757 ) , .A1 ( n1320 ) , .B0 ( n1330 ) , 
    .B1 ( n1838 ) , .Y ( \u_mac16_top/u_mac/add_tmp_comb [22] ) ) ;
XOR2X0P7H9R ctmTdsLR_2_154 ( .A ( tmp_net38 ) , .B ( n2366 ) , .Y ( n1178 ) ) ;
XOR2X1H9R U2054 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [16] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s40 [16] ) , .Y ( n1156 ) ) ;
NOR2X0P5H9R U2065 ( .A ( n1641 ) , .B ( n984 ) , .Y ( n986 ) ) ;
AOI2XB1X0P5H9R ctmTdsLR_1_93 ( .A1N ( n1683 ) , .A0 ( n1653 ) , 
    .B0 ( n1654 ) , .Y ( tmp_net18 ) ) ;
...
MUXIT2X0P5H9R U2070 ( .A ( \u_mac16_top/op_fifo_wr_ptr [0] ) , .B ( n1468 ) , 
    .S0 ( n1467 ) , .Y ( n940 ) ) ;
XOR2X0P5H9R ctmTdsLR_2_94 ( .A ( tmp_net18 ) , .B ( n1659 ) , .Y ( n1670 ) ) ;
MUXIT2X0P5H9R U2072 ( .A ( \u_mac16_top/fifo_rd_ptr [0] ) , .B ( n1071 ) , 
    .S0 ( n1070 ) , .Y ( n942 ) ) ;
XOR3X1H9R ctmTdsLR_1_815 ( .A ( tmp_net56 ) , .B ( n1161 ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s40 [14] ) , .Y ( n1130 ) ) ;
MUXIT2X0P5H9R U2075 ( .A ( \u_mac16_top/fifo_wr_ptr [1] ) , .B ( n957 ) , 
    .S0 ( n956 ) , .Y ( n945 ) ) ;
MUXIT2X0P5H9R U2076 ( .A ( \u_mac16_top/op_fifo_wr_ptr [1] ) , .B ( n955 ) , 
    .S0 ( n1467 ) , .Y ( n946 ) ) ;
MUXIT2X0P5H9R ctmTdsLR_1_95 ( .A ( n1472 ) , .B ( n1467 ) , .S0 ( n2339 ) , 
    .Y ( \u_mac16_top/net605 ) ) ;
NAND2BX0P7H9R ctmTdsLR_1_96 ( .AN ( n1324 ) , .B ( n1322 ) , .Y ( n1275 ) ) ;
AOI2XB1X0P5H9R ctmTdsLR_1_97 ( .A1N ( n1822 ) , .A0 ( n1574 ) , 
    .B0 ( n1577 ) , .Y ( tmp_net19 ) ) ;
XOR2X0P5H9R ctmTdsLR_2_98 ( .A ( tmp_net19 ) , .B ( n1318 ) , .Y ( n1320 ) ) ;
AOI21X0P5H9R ctmTdsLR_1_99 ( .A0 ( \u_mac16_top/u_mac/mult_result [23] ) , 
    .A1 ( \u_mac16_top/u_mac/last_prod [23] ) , .B0 ( n1828 ) , 
    .Y ( tmp_net20 ) ) ;
NAND3X0P5H9R ctmTdsLR_1_130 ( .A ( n1074 ) , .B ( n1075 ) , .C ( n1070 ) , 
    .Y ( tmp_net32 ) ) ;
AOI221X0P5H9R ctmTdsLR_2_54 ( .A0 ( n1654 ) , .A1 ( n1658 ) , 
    .B0 ( \u_mac16_top/u_mac/mult_result [10] ) , 
    .B1 ( \u_mac16_top/u_mac/last_prod [10] ) , .C0 ( tmp_net3 ) , 
    .Y ( n937 ) ) ;
INVX0P5H9R U2086 ( .A ( n1646 ) , .Y ( n1628 ) ) ;
AOI2XB1X0P5H9R ctmTdsLR_1_55 ( .A1N ( n1822 ) , .A0 ( n1292 ) , 
    .B0 ( n1293 ) , .Y ( n941 ) ) ;
...
INVX0P5H9R U2103 ( .A ( \u_mac16_top/cal_done ) , .Y ( n1070 ) ) ;
...
OAI21X0P7H9R U2134 ( .A0 ( n1787 ) , .A1 ( n1797 ) , .B0 ( n1788 ) , 
    .Y ( n1761 ) ) ;
...
OAI21X0P5H9R U2147 ( .A0 ( n1671 ) , .A1 ( n1685 ) , .B0 ( n1672 ) , 
    .Y ( n1654 ) ) ;
NOR2X0P5H9R U2160 ( .A ( n1248 ) , .B ( n1252 ) , .Y ( n988 ) ) ;
...
NAND2X0P5H9R U2184 ( .A ( n1725 ) , .B ( n995 ) , .Y ( n997 ) ) ;
...
NOR2X0P5H9R U2205 ( .A ( n1239 ) , .B ( n1243 ) , .Y ( n1007 ) ) ;
...
NOR2XBX1P4H9R ctmTdsLR_1_158 ( .BN ( n1165 ) , .A ( n1167 ) , .Y ( n1169 ) ) ;
OAI21X0P5H9R ctmTdsLR_2_131 ( .A0 ( n1070 ) , 
    .A1 ( \u_mac16_top/fifo_rd_ptr [1] ) , .B0 ( tmp_net32 ) , .Y ( n944 ) ) ;
ADDFX1H9R U2233 ( .A ( n1064 ) , .B ( n1063 ) , .CI ( n1062 ) , 
    .CO ( n1066 ) , .S ( n970 ) ) ;
INVX0P5H9R U2234 ( .A ( \u_mac16_top/opB_reg [14] ) , .Y ( n1883 ) ) ;
AO22X0P5H9R ctmTdsLR_1_159 ( .A0 ( n1290 ) , .A1 ( n1838 ) , .B0 ( n1284 ) , 
...
OAI21BX0P5H9R ctmTdsLR_1_193 ( .A0 ( n1326 ) , .A1 ( n1834 ) , 
    .B0N ( n1830 ) , .Y ( n1568 ) ) ;
CGENCONAX1H9R U2284 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [11] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [11] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s40 [11] ) , .CON ( n1126 ) ) ;
CGENCONAX1H9R U2285 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [13] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [13] ) , .CI ( ZBUF_17_9 ) , 
    .CON ( n1161 ) ) ;
CGENCONAX1H9R U2286 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [18] ) , 
    .B ( ZBUF_35_10 ) , .CI ( \u_mac16_top/u_mac/u_mul/r_s41 [18] ) , 
    .CON ( n1137 ) ) ;
CGENCONAX1H9R U2289 ( .A ( \u_mac16_top/u_mac/u_mul/r_c41 [19] ) , 
    .B ( n1134 ) , .CI ( n1133 ) , .CON ( n1179 ) ) ;
NOR2BX1H9R ctmTdsLR_1_162 ( .AN ( n1176 ) , .B ( n1175 ) , .Y ( n1526 ) ) ;
OR2X0P7H9R ctmTdsLR_1_163 ( .A ( n1178 ) , .B ( n1179 ) , .Y ( n1349 ) ) ;
XNOR2X0P5H9R ctmTdsLR_2_816 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [14] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [14] ) , .Y ( tmp_net56 ) ) ;
XOR3X1H9R ctmTdsLR_1_164 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [11] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [11] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s41 [11] ) , .Y ( n1128 ) ) ;
...
XOR2X1H9R ctmTdsLR_1_194 ( .A ( n1158 ) , .B ( n867 ) , .Y ( n2381 ) ) ;
...
ADDFX1H9R U2321 ( .A ( n1232 ) , .B ( n1231 ) , .CI ( n1230 ) , 
    .CO ( n1233 ) , .S ( n963 ) ) ;
XNOR3X1H9R ctmTdsLR_1_166 ( .A ( ZBUF_17_9 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [13] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s40 [13] ) , .Y ( n930 ) ) ;
OR2X1P4H9R ctmTdsLR_1_195 ( .A ( n1114 ) , .B ( n1115 ) , .Y ( n1560 ) ) ;
INVX0P5H9R U2333 ( .A ( n1820 ) , .Y ( n1262 ) ) ;
XOR2X0P5H9R ctmTdsLR_2_100 ( .A ( n1573 ) , .B ( tmp_net20 ) , .Y ( n1584 ) ) ;
AOI31X0P5H9R ctmTdsLR_1_196 ( .A0 ( n2224 ) , 
    .A1 ( \u_mac16_top/opA_reg [15] ) , .A2 ( \u_mac16_top/opB_reg [8] ) , 
    .B0 ( n2220 ) , .Y ( n2226 ) ) ;
OAI211X0P5H9R ctmTdsLR_1_101 ( .A0 ( n1822 ) , .A1 ( n1242 ) , .B0 ( n1296 ) , 
    .C0 ( tmp_net5 ) , .Y ( tmp_net21 ) ) ;
XNOR3X1H9R ctmTdsLR_1_817 ( .A ( n1136 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [19] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_c41 [19] ) , .Y ( tmp_net57 ) ) ;
XNOR2X0P5H9R ctmTdsLR_2_102 ( .A ( tmp_net21 ) , .B ( n1246 ) , .Y ( n1247 ) ) ;
NOR3X0P5H9R ctmTdsLR_1_132 ( .A ( \u_mac16_top/p2s_issue_hold ) , 
    .B ( \u_mac16_top/cal_done ) , .C ( \u_mac16_top/u_out/busy ) , 
    .Y ( tmp_net33 ) ) ;
XOR3X1H9R ctmTdsLR_1_818 ( .A ( n1152 ) , .B ( tmp_net58 ) , .C ( n935 ) , 
    .Y ( n869 ) ) ;
OAI21X0P5H9R ctmTdsLR_1_103 ( .A0 ( n1585 ) , .A1 ( n1825 ) , .B0 ( n1834 ) , 
    .Y ( tmp_net22 ) ) ;
XNOR2X0P5H9R ctmTdsLR_2_104 ( .A ( tmp_net22 ) , .B ( n989 ) , .Y ( n991 ) ) ;
CGENX1H9R ctmTdsLR_1_171 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [10] ) , 
    .B ( ZBUF_69_7 ) , .CI ( \u_mac16_top/u_mac/u_mul/r_s40 [10] ) , 
    .CO ( n1129 ) ) ;
...
OAI2XB1X0P5H9R ctmTdsLR_1_35 ( .A1N ( n1605 ) , .A0 ( n1609 ) , 
    .B0 ( n1610 ) , .Y ( n1017 ) ) ;
INVX1H9R HFSINV_28332_1 ( .A ( HFSNET_26 ) , .Y ( HFSNET_1 ) ) ;
INVX0P7H9R HFSINV_3673_2 ( .A ( HFSNET_26 ) , .Y ( HFSNET_2 ) ) ;
INVX0P7H9R HFSINV_7871_3 ( .A ( HFSNET_26 ) , .Y ( HFSNET_3 ) ) ;
INVX0P7H9R HFSINV_4958_4 ( .A ( HFSNET_26 ) , .Y ( HFSNET_4 ) ) ;
INVX0P7H9R HFSINV_6108_5 ( .A ( HFSNET_26 ) , .Y ( HFSNET_5 ) ) ;
INVX1H9R HFSINV_2303_6 ( .A ( HFSNET_26 ) , .Y ( HFSNET_6 ) ) ;
INVX0P7H9R HFSINV_23993_7 ( .A ( HFSNET_26 ) , .Y ( HFSNET_7 ) ) ;
INVX0P5H9R HFSINV_18720_8 ( .A ( HFSNET_26 ) , .Y ( HFSNET_8 ) ) ;
INVX0P7H9R HFSINV_12912_9 ( .A ( HFSNET_26 ) , .Y ( HFSNET_9 ) ) ;
INVX1H9R HFSINV_15002_10 ( .A ( HFSNET_26 ) , .Y ( HFSNET_10 ) ) ;
INVX0P5H9R HFSINV_9072_11 ( .A ( HFSNET_26 ) , .Y ( HFSNET_11 ) ) ;
INVX0P7H9R HFSINV_10454_12 ( .A ( HFSNET_26 ) , .Y ( HFSNET_12 ) ) ;
INVX0P7H9R HFSINV_16807_13 ( .A ( HFSNET_26 ) , .Y ( HFSNET_13 ) ) ;
INVX0P7H9R HFSINV_21132_14 ( .A ( HFSNET_26 ) , .Y ( HFSNET_14 ) ) ;
OAI2XB1X0P5H9R ctmTdsLR_1_36 ( .A1N ( n1717 ) , .A0 ( n1719 ) , 
    .B0 ( n1720 ) , .Y ( n1698 ) ) ;
INVX2H9R HFSINV_63164_16 ( .A ( HFSNET_26 ) , .Y ( HFSNET_16 ) ) ;
INVX0P5H9R HFSINV_61757_17 ( .A ( HFSNET_26 ) , .Y ( HFSNET_17 ) ) ;
INVX1H9R HFSINV_52713_18 ( .A ( HFSNET_26 ) , .Y ( HFSNET_18 ) ) ;
INVX0P5H9R HFSINV_51492_19 ( .A ( HFSNET_26 ) , .Y ( HFSNET_19 ) ) ;
INVX0P7H9R HFSINV_47592_20 ( .A ( HFSNET_26 ) , .Y ( HFSNET_20 ) ) ;
INVX1H9R HFSINV_45899_21 ( .A ( HFSNET_26 ) , .Y ( HFSNET_21 ) ) ;
INVX1H9R HFSINV_51045_22 ( .A ( HFSNET_26 ) , .Y ( HFSNET_22 ) ) ;
INVX0P7H9R HFSINV_56595_23 ( .A ( HFSNET_26 ) , .Y ( HFSNET_23 ) ) ;
INVX0P7H9R HFSINV_54730_24 ( .A ( HFSNET_26 ) , .Y ( HFSNET_24 ) ) ;
INVX1P4H9R HFSINV_59558_25 ( .A ( HFSNET_26 ) , .Y ( HFSNET_25 ) ) ;
FREEICGX2P5H9R HFSBUF_67202_26 ( .CK ( n2367 ) , .ECK ( HFSNET_26 ) ) ;
FREEICGX0P8H9R HFSBUF_42529_27 ( .CK ( HFSNET_32 ) , .ECK ( HFSNET_27 ) ) ;
FREEICGX0P8H9R HFSBUF_34608_28 ( .CK ( HFSNET_32 ) , .ECK ( HFSNET_28 ) ) ;
FREEICGX0P7H9R HFSBUF_36427_29 ( .CK ( HFSNET_32 ) , .ECK ( HFSNET_29 ) ) ;
FREEICGX1P2H9R HFSBUF_31684_30 ( .CK ( HFSNET_32 ) , .ECK ( HFSNET_30 ) ) ;
FREEICGX0P8H9R HFSBUF_39107_31 ( .CK ( HFSNET_32 ) , .ECK ( HFSNET_31 ) ) ;
INVX1P7H9R HFSINV_66868_32 ( .A ( n2367 ) , .Y ( HFSNET_32 ) ) ;
OAI2XB1X0P5H9R ctmTdsLR_1_37 ( .A1N ( n1724 ) , .A0 ( n1726 ) , 
    .B0 ( n1727 ) , .Y ( n1708 ) ) ;
AOI21X2H9R ctmTdsLR_1_38 ( .A0 ( n899 ) , .A1 ( n1108 ) , .B0 ( n1118 ) , 
    .Y ( n891 ) ) ;
NAND2XBX0P7H9R ctmTdsLR_1_105 ( .BN ( n1553 ) , .A ( n1554 ) , .Y ( n1556 ) ) ;
OAI21X1P4H9R ctmTdsLR_1_40 ( .A0 ( n1128 ) , .A1 ( n1129 ) , .B0 ( n886 ) , 
    .Y ( n923 ) ) ;
NAND3X0P7H9R ctmTdsLR_1_41 ( .A ( n2354 ) , .B ( n1494 ) , .C ( n1546 ) , 
    .Y ( n1538 ) ) ;
...
XOR3X0P5H9R U2409 ( .A ( \u_mac16_top/u_mac/u_mul/r_s30 [19] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c30 [19] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s31 [19] ) , 
...
XOR3X0P5H9R U2413 ( .A ( \u_mac16_top/u_mac/u_mul/r_c30 [15] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s31 [15] ) , 
...
XOR3X0P5H9R U2415 ( .A ( \u_mac16_top/u_mac/u_mul/r_s30 [16] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c30 [16] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s31 [16] ) , 
...
XOR3X0P5H9R U2423 ( .A ( \u_mac16_top/u_mac/u_mul/r_s30 [18] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c30 [18] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s31 [18] ) , 
...
NOR2X1H9R U2430 ( .A ( \u_mac16_top/u_out/bits_left [0] ) , 
    .B ( \u_mac16_top/u_out/bits_left [1] ) , .Y ( n1511 ) ) ;
NOR2X0P5H9R U2431 ( .A ( \u_mac16_top/op_fifo_count [1] ) , 
    .B ( \u_mac16_top/op_fifo_count [0] ) , .Y ( n1847 ) ) ;
AOI2XB1X0P5H9R U2432 ( .A1N ( \u_mac16_top/op_fifo_count [2] ) , 
    .A0 ( n1847 ) , .B0 ( \u_mac16_top/schedule_active ) , .Y ( n2339 ) ) ;
AOI221X0P5H9R ctmTdsLR_1_42 ( .A0 ( n2359 ) , .A1 ( n1262 ) , .B0 ( n1817 ) , 
    .B1 ( n1816 ) , .C0 ( n1815 ) , .Y ( tmp_net0 ) ) ;
OAI31X0P5H9R ctmTdsLR_2_43 ( .A0 ( n1822 ) , .A1 ( n1819 ) , .A2 ( n1811 ) , 
    .B0 ( tmp_net0 ) , .Y ( n1839 ) ) ;
NOR2XBX1H9R ctmTdsLR_1_44 ( .BN ( n1546 ) , .A ( n1476 ) , .Y ( tmp_net1 ) ) ;
NAND4XXXBX2H9R ctmTdsLR_2_45 ( .DN ( n2385 ) , .A ( n1545 ) , 
    .B ( tmp_net1 ) , .C ( n1494 ) , .Y ( n919 ) ) ;
NOR2X0P7H9R ctmTdsLR_1_46 ( .A ( n1357 ) , .B ( n1355 ) , .Y ( tmp_net2 ) ) ;
XNOR2X0P7H9R ctmTdsLR_2_47 ( .A ( n1536 ) , .B ( tmp_net2 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N50 ) ) ;
AOI2XB1X0P7H9R ctmTdsLR_1_48 ( .A1N ( n1355 ) , .A0 ( n2387 ) , 
    .B0 ( n1357 ) , .Y ( n1358 ) ) ;
OAI31X2H9R ctmTdsLR_2_49 ( .A0 ( n847 ) , .A1 ( n1530 ) , .A2 ( n1355 ) , 
    .B0 ( n1358 ) , .Y ( n861 ) ) ;
NOR2X0P5H9R ctmTdsLR_1_56 ( .A ( n1683 ) , .B ( n1033 ) , .Y ( tmp_net4 ) ) ;
NAND2X0P7H9R U2443 ( .A ( n1511 ) , .B ( n1372 ) , .Y ( n1514 ) ) ;
ADDFX1H9R U2455 ( .A ( n1461 ) , .B ( n1460 ) , .CI ( n1459 ) , 
    .CO ( n1462 ) , .S ( n1339 ) ) ;
XNOR3X0P5H9R ctmTdsLR_1_172 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [14] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [14] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s40 [14] ) , .Y ( n1162 ) ) ;
OAI211X1H9R ctmTdsLR_1_173 ( .A0 ( \u_mac16_top/u_mac/u_mul/r_c40 [7] ) , 
    .A1 ( ZBUF_50_13 ) , .B0 ( n1113 ) , .C0 ( n1112 ) , .Y ( n1115 ) ) ;
...
NAND2X0P7H9R ctmTdsLR_2_133 ( .A ( n1518 ) , .B ( tmp_net33 ) , .Y ( n1517 ) ) ;
XOR2X1H9R ctmTdsLR_1_134 ( .A ( ZBUF_9_8 ) , .B ( n1484 ) , .Y ( ZBUF_2_6 ) ) ;
...
CGENX1H9R U2476 ( .A ( \u_mac16_top/u_mac/u_mul/r_c30 [15] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s31 [15] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s30 [15] ) , .CO ( n2269 ) ) ;
CGENX1H9R U2477 ( .A ( \u_mac16_top/u_mac/u_mul/r_s30 [16] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c30 [16] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s31 [16] ) , .CO ( n2270 ) ) ;
CGENX1H9R U2478 ( .A ( \u_mac16_top/u_mac/u_mul/r_s23 [18] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c31 [18] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_c23 [18] ) , .CO ( n2271 ) ) ;
...
CGENX1H9R U2488 ( .A ( \u_mac16_top/u_mac/u_mul/r_c30 [18] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s31 [18] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s30 [18] ) , .CO ( n2281 ) ) ;
...
CGENX1H9R U2493 ( .A ( \u_mac16_top/u_mac/u_mul/r_c30 [20] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s31 [20] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s30 [20] ) , .CO ( n2286 ) ) ;
...
XNOR2X0P5H9R ctmTdsLR_2_819 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [17] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c41 [17] ) , .Y ( tmp_net58 ) ) ;
AOI21X0P5H9R ctmTdsLR_1_197 ( .A0 ( n2072 ) , .A1 ( n2073 ) , .B0 ( n2074 ) , 
    .Y ( n2080 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_135 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [18] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [18] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_s40 [18] ) , .Y ( n1139 ) ) ;
OAI31X0P5H9R U2511 ( .A0 ( n926 ) , .A1 ( n1518 ) , .A2 ( n2145 ) , 
    .B0 ( n1517 ) , .Y ( \u_mac16_top/N91 ) ) ;
OAI21X0P5H9R ctmTdsLR_1_106 ( .A0 ( \u_mac16_top/u_inA/cnt [0] ) , 
    .A1 ( \u_mac16_top/u_inA/cnt [1] ) , .B0 ( n1808 ) , .Y ( tmp_net23 ) ) ;
XOR2X0P5H9R U2516 ( .A ( n1563 ) , .B ( n1564 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N39 ) ) ;
OAI21X0P5H9R U2521 ( .A0 ( n1579 ) , .A1 ( n1822 ) , .B0 ( n1578 ) , 
    .Y ( n1582 ) ) ;
AO22X0P5H9R U2522 ( .A0 ( n1584 ) , .A1 ( n1838 ) , .B0 ( n1757 ) , 
    .B1 ( n1583 ) , .Y ( \u_mac16_top/u_mac/add_tmp_comb [23] ) ) ;
NAND3X0P5H9R ctmTdsLR_1_174 ( .A ( n1500 ) , .B ( n1845 ) , 
...
AO22X0P5H9R U2540 ( .A0 ( n1652 ) , .A1 ( n1838 ) , .B0 ( n1757 ) , 
    .B1 ( n1651 ) , .Y ( \u_mac16_top/u_mac/add_tmp_comb [12] ) ) ;
NOR2X0P5H9R ctmTdsLR_2_107 ( .A ( n1806 ) , .B ( tmp_net23 ) , 
    .Y ( \u_mac16_top/u_inA/N50 ) ) ;
XOR3X0P7H9R ctmTdsLR_1_137 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [21] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [21] ) , 
    .C ( \u_mac16_top/u_mac/u_mul/r_c40 [21] ) , .Y ( n1147 ) ) ;
OAI21X0P5H9R ctmTdsLR_1_108 ( .A0 ( n1585 ) , .A1 ( n1251 ) , .B0 ( n1250 ) , 
    .Y ( tmp_net24 ) ) ;
XNOR2X0P5H9R ctmTdsLR_2_109 ( .A ( tmp_net24 ) , .B ( n1255 ) , .Y ( n1256 ) ) ;
AND2X1H9R ctmTdsLR_1_820 ( .A ( tmp_net59 ) , .B ( n1175 ) , .Y ( n1527 ) ) ;
AOI31X1H9R ctmTdsLR_1_110 ( .A0 ( n1538 ) , .A1 ( n2369 ) , .A2 ( n1477 ) , 
    .B0 ( n1476 ) , .Y ( tmp_net25 ) ) ;
INVX0P5H9R U2554 ( .A ( n1684 ) , .Y ( n1686 ) ) ;
NAND2XBX0P5H9R ctmTdsLR_2_111 ( .BN ( n2385 ) , .A ( n922 ) , 
    .Y ( tmp_net26 ) ) ;
AOI211X0P7H9R ctmTdsLR_2_57 ( .A0 ( n1031 ) , .A1 ( n1619 ) , .B0 ( n1030 ) , 
    .C0 ( tmp_net4 ) , .Y ( n948 ) ) ;
OAI21BX0P5H9R ctmTdsLR_1_198 ( .A0 ( n1315 ) , .A1 ( n1820 ) , 
    .B0N ( n1816 ) , .Y ( n1577 ) ) ;
AND2X2H9R ctmTdsLR_1_199 ( .A ( n1114 ) , .B ( n1115 ) , .Y ( n889 ) ) ;
NAND2BX1P4H9R ctmTdsLR_1_186 ( .AN ( n1111 ) , .B ( n1122 ) , .Y ( n1495 ) ) ;
NAND2XBX0P7H9R ctmTdsLR_1_187 ( .BN ( n1780 ) , .A ( n1781 ) , .Y ( n1783 ) ) ;
OAI2XB1X0P5H9R U2590 ( .A1N ( out_ready ) , .A0 ( n1842 ) , .B0 ( n1841 ) , 
    .Y ( n730 ) ) ;
AOI2XB1X0P5H9R ctmTdsLR_1_58 ( .A1N ( n1585 ) , .A0 ( n1565 ) , 
    .B0 ( n1568 ) , .Y ( n949 ) ) ;
...
NAND2X0P7H9R ctmTdsLR_1_832 ( .A ( n1508 ) , .B ( tmp_net60 ) , .Y ( n1518 ) ) ;
...
ADDFX1H9R U2659 ( .A ( n1901 ) , .B ( n1900 ) , .CI ( n1899 ) , 
    .CO ( n1897 ) , .S ( n1907 ) ) ;
INVX0P5H9R ctmTdsLR_2_833 ( .A ( n1507 ) , .Y ( tmp_net60 ) ) ;
...
ADDFX1H9R U2680 ( .A ( n1961 ) , .B ( n1960 ) , .CI ( n1959 ) , 
    .CO ( n1966 ) , .S ( n1067 ) ) ;
OR2X0P5H9R ctmTdsLR_3_836 ( .A ( n1640 ) , .B ( n984 ) , .Y ( tmp_net62 ) ) ;
...
OR2X0P5H9R U2806 ( .A ( n2213 ) , .B ( n2212 ) , .Y ( \u_mac16_top/N178 ) ) ;
...
SDFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/r_c41_reg[19] ( .D ( n2271 ) , 
    .SI ( optlc_net_104 ) , .SE ( optlc_net_104 ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net771 ) , .R ( HFSNET_28 ) , 
...
OAI21X0P5H9R ctmTdsLR_2_175 ( .A0 ( n1502 ) , 
    .A1 ( \u_mac16_top/schedule_active ) , .B0 ( tmp_net41 ) , .Y ( n2347 ) ) ;
OAI211X1H9R U1566 ( .A0 ( n1210 ) , .A1 ( n1209 ) , .B0 ( n1346 ) , 
    .C0 ( n1208 ) , .Y ( n933 ) ) ;
AOI21X2H9R U1173 ( .A0 ( n1356 ) , .A1 ( n1174 ) , .B0 ( n1173 ) , 
    .Y ( n1209 ) ) ;
NOR2X1H9R U1588 ( .A ( ZBUF_190_3 ) , .B ( ZBUF_101_7 ) , .Y ( n881 ) ) ;
NOR2X0P5H9R U1638 ( .A ( ZBUF_190_3 ) , .B ( ZBUF_17_13 ) , .Y ( n882 ) ) ;
DFFRQX1H9R \u_mac16_top/u_mac/last_prod_reg[12] ( .D ( ropt_net_105 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[3] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N36 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
...
DFFRX1H9R \u_mac16_top/u_mac/mode_d_reg ( .D ( mode ) , 
    .CK ( \u_mac16_top/u_mac/u_mul/net721 ) , .RDN ( HFSNET_26 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/last_prod_reg[18] ( .D ( copt_net_93 ) , 
    .CK ( \u_mac16_top/u_mac/net693 ) , .R ( HFSNET_29 ) , 
...
DFFRX1H9R \u_mac16_top/opB_reg_reg[9] ( .D ( n782 ) , 
    .CK ( \u_mac16_top/net564 ) , .RDN ( HFSNET_26 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/mac_result_shadow_reg[2] ( 
    .D ( \u_mac16_top/N94 ) , .CK ( \u_mac16_top/net622 ) , .R ( HFSNET_21 ) , 
    .Q ( \u_mac16_top/mac_result_shadow [2] ) ) ;
NOR2X0P5H9R ctmTdsLR_1_176 ( .A ( n1828 ) , .B ( n1827 ) , .Y ( tmp_net42 ) ) ;
AOI221X0P5H9R ctmTdsLR_2_177 ( .A0 ( n1830 ) , .A1 ( n1831 ) , 
    .B0 ( \u_mac16_top/u_mac/mult_result [23] ) , 
    .B1 ( \u_mac16_top/u_mac/last_prod [23] ) , .C0 ( tmp_net42 ) , 
    .Y ( n1832 ) ) ;
NOR2X0P7H9R U1057 ( .A ( \u_mac16_top/u_mac/mult_result [19] ) , 
    .B ( \u_mac16_top/u_mac/last_prod [19] ) , .Y ( n1252 ) ) ;
DLY2X0P5H9R copt_h_inst_837 ( .A ( \u_mac16_top/u_inB/shift_reg [0] ) , 
    .Y ( copt_net_63 ) ) ;
XOR2X2H9R U1063 ( .A ( n1214 ) , .B ( n1215 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N55 ) ) ;
OAI211X0P5H9R ctmTdsLR_1_188 ( .A0 ( \u_mac16_top/u_mac/mult_result [0] ) , 
    .A1 ( \u_mac16_top/u_mac/accum_reg [0] ) , 
    .B0 ( \u_mac16_top/u_mac/mode_d ) , .C0 ( n1799 ) , .Y ( tmp_net46 ) ) ;
OAI211X0P5H9R ctmTdsLR_2_189 ( .A0 ( \u_mac16_top/u_mac/mult_result [0] ) , 
    .A1 ( \u_mac16_top/u_mac/last_prod [0] ) , .B0 ( n1838 ) , .C0 ( n1797 ) , 
    .Y ( tmp_net47 ) ) ;
XOR2X0P7H9R U1069 ( .A ( n930 ) , .B ( n1125 ) , .Y ( n1132 ) ) ;
NOR2X1H9R U1074 ( .A ( n930 ) , .B ( n1125 ) , .Y ( n902 ) ) ;
NOR2X1P4H9R U1078 ( .A ( n1127 ) , .B ( n1126 ) , .Y ( n1131 ) ) ;
CGENCONAX1H9R U1084 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [12] ) , 
    .B ( ZBUF_17_8 ) , .CI ( \u_mac16_top/u_mac/u_mul/r_s40 [12] ) , 
    .CON ( n1125 ) ) ;
...
AOI21X1H9R U1127 ( .A0 ( n1524 ) , .A1 ( n909 ) , .B0 ( n1343 ) , 
    .Y ( n1345 ) ) ;
OAI221X0P5H9R ctmTdsLR_1_200 ( .A0 ( n1585 ) , .A1 ( n1835 ) , .B0 ( n1833 ) , 
    .B1 ( n1834 ) , .C0 ( n1832 ) , .Y ( n1836 ) ) ;
AO22X0P5H9R ctmTdsLR_1_201 ( .A0 ( n1050 ) , .A1 ( n1757 ) , .B0 ( n1059 ) , 
    .B1 ( n1838 ) , .Y ( \u_mac16_top/u_mac/add_tmp_comb [11] ) ) ;
DLY2X0P5H9R copt_h_inst_838 ( .A ( \u_mac16_top/u_inB/shift_reg [1] ) , 
    .Y ( copt_net_64 ) ) ;
NOR2X0P5H9R ctmTdsLR_1_202 ( .A ( n1875 ) , .B ( n2107 ) , .Y ( tmp_net48 ) ) ;
XOR2X2H9R U1138 ( .A ( ZBUF_17_13 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [15] ) , .Y ( n1158 ) ) ;
OR2X1H9R ctmTdsLR_1_178 ( .A ( n1168 ) , .B ( n1167 ) , .Y ( n1491 ) ) ;
XNOR2X0P5H9R U1141 ( .A ( n852 ) , .B ( n1266 ) , .Y ( n1267 ) ) ;
INVX0P5H9R ctmTdsLR_2_821 ( .A ( n1176 ) , .Y ( tmp_net59 ) ) ;
NAND2X0P5H9R ctmTdsLR_3_190 ( .A ( tmp_net46 ) , .B ( tmp_net47 ) , 
    .Y ( \u_mac16_top/u_mac/add_tmp_comb [0] ) ) ;
NAND2X1P4H9R U1145 ( .A ( n1179 ) , .B ( n1178 ) , .Y ( n876 ) ) ;
XOR2X0P7H9R ctmTdsLR_1_139 ( .A ( ZBUF_35_10 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c41 [18] ) , .Y ( tmp_net34 ) ) ;
NAND2XBX0P7H9R ctmTdsLR_1_191 ( .BN ( n1791 ) , .A ( n1792 ) , .Y ( n1794 ) ) ;
AO22X0P5H9R ctmTdsLR_1_192 ( .A0 ( n1026 ) , .A1 ( n1757 ) , .B0 ( n1038 ) , 
...
AOI2XB1X0P5H9R ctmTdsLR_1_59 ( .A1N ( n1585 ) , .A0 ( n1300 ) , 
    .B0 ( n1301 ) , .Y ( n950 ) ) ;
OAI21X0P5H9R U1183 ( .A0 ( n1633 ) , .A1 ( n1647 ) , .B0 ( n1634 ) , 
    .Y ( n1605 ) ) ;
NOR2X0P5H9R U1184 ( .A ( \u_mac16_top/u_mac/mult_result [13] ) , 
    .B ( \u_mac16_top/u_mac/accum_reg [13] ) , .Y ( n1633 ) ) ;
OAI21X0P7H9R U1186 ( .A0 ( n997 ) , .A1 ( n1705 ) , .B0 ( n996 ) , 
    .Y ( n1013 ) ) ;
AOI21X0P7H9R U1187 ( .A0 ( n1767 ) , .A1 ( n993 ) , .B0 ( n992 ) , 
    .Y ( n1705 ) ) ;
AOI31X1H9R U1191 ( .A0 ( n2376 ) , .A1 ( n1525 ) , .A2 ( n1532 ) , 
    .B0 ( n933 ) , .Y ( n1215 ) ) ;
NOR2X0P5H9R U1192 ( .A ( n1768 ) , .B ( n1780 ) , .Y ( n993 ) ) ;
NAND2X0P5H9R ctmTdsLR_1_60 ( .A ( n1293 ) , .B ( n1297 ) , .Y ( tmp_net5 ) ) ;
MUXIT2X0P5H9R ctmTdsLR_2_203 ( .A ( n1457 ) , .B ( tmp_net48 ) , 
    .S0 ( n1455 ) , 
...
NOR2XBX2H9R ctmTdsLR_1_204 ( .BN ( n1174 ) , .A ( n1530 ) , .Y ( n1525 ) ) ;
...
NAND4X0P5H9R U1209 ( .A ( \u_mac16_top/u_inB/cnt [0] ) , 
    .B ( \u_mac16_top/u_inB/cnt [1] ) , .C ( \u_mac16_top/u_inB/cnt [3] ) , 
    .D ( \u_mac16_top/u_inB/cnt [2] ) , .Y ( n2198 ) ) ;
NAND4X0P5H9R U1210 ( .A ( \u_mac16_top/u_inA/cnt [0] ) , 
    .B ( \u_mac16_top/u_inA/cnt [1] ) , .C ( \u_mac16_top/u_inA/cnt [3] ) , 
    .D ( \u_mac16_top/u_inA/cnt [2] ) , .Y ( n2200 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_142 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [22] ) , 
...
DLY2X0P5H9R copt_h_inst_839 ( .A ( \u_mac16_top/u_inB/shift_reg [2] ) , 
    .Y ( copt_net_65 ) ) ;
OAI21X2H9R U1229 ( .A0 ( ZBUF_59_10 ) , 
    .A1 ( \u_mac16_top/u_mac/u_mul/r_s40 [9] ) , .B0 ( n1111 ) , .Y ( n899 ) ) ;
NAND2X1P4H9R U1231 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [8] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [8] ) , .Y ( n1108 ) ) ;
FREEICGX2H9R ZBUF_190_inst_715 ( .CK ( \u_mac16_top/u_mac/u_mul/r_c41 [15] ) , 
    .ECK ( ZBUF_190_3 ) ) ;
...
NAND2X1H9R U1248 ( .A ( n843 ) , .B ( n842 ) , .Y ( n841 ) ) ;
DLY2X0P5H9R copt_h_inst_840 ( .A ( \u_mac16_top/u_inB/shift_reg [3] ) , 
    .Y ( copt_net_66 ) ) ;
INVX0P5H9R ctmTdsLR_1_62 ( .A ( n1585 ) , .Y ( tmp_net6 ) ) ;
XNOR2X0P5H9R U1254 ( .A ( n935 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [17] ) , .Y ( n1150 ) ) ;
...
INVX0P5H9R ctmTdsLR_2_63 ( .A ( n1825 ) , .Y ( tmp_net7 ) ) ;
...
XNOR2X0P5H9R ctmTdsLR_3_112 ( .A ( tmp_net25 ) , .B ( tmp_net26 ) , 
...
DLY2X0P5H9R copt_h_inst_841 ( .A ( \u_mac16_top/u_inB/shift_reg [4] ) , 
    .Y ( copt_net_67 ) ) ;
OAI21X0P5H9R ctmTdsLR_1_113 ( .A0 ( n1499 ) , .A1 ( n1497 ) , .B0 ( n2363 ) , 
    .Y ( tmp_net27 ) ) ;
...
OAI21X0P5H9R ctmTdsLR_3_64 ( .A0 ( n1834 ) , .A1 ( n1321 ) , .B0 ( n1323 ) , 
    .Y ( tmp_net8 ) ) ;
XNOR2X0P5H9R ctmTdsLR_2_114 ( .A ( tmp_net27 ) , .B ( n1548 ) , 
...
NAND2XBX0P7H9R ctmTdsLR_1_115 ( .BN ( n1142 ) , .A ( n1349 ) , 
    .Y ( tmp_net28 ) ) ;
XNOR2X1P4H9R ctmTdsLR_2_116 ( .A ( n864 ) , .B ( tmp_net28 ) , 
    .Y ( ZBUF_2_10 ) ) ;
NOR2X0P5H9R U1318 ( .A ( n1947 ) , .B ( n2000 ) , .Y ( n1892 ) ) ;
NOR2X0P5H9R U1319 ( .A ( n2107 ) , .B ( n1882 ) , .Y ( n1903 ) ) ;
NAND2XBX0P5H9R U1320 ( .BN ( n1742 ) , .A ( n1743 ) , .Y ( n1745 ) ) ;
...
CGENCONAX1H9R ctmTdsLR_2_823 ( .A ( n1873 ) , .B ( n1872 ) , .CI ( n1871 ) , 
    .CON ( n1877 ) ) ;
...
NOR3X0P5H9R U1329 ( .A ( n1633 ) , .B ( n1609 ) , .C ( n1627 ) , 
    .Y ( n1018 ) ) ;
...
NAND2X0P5H9R ctmTdsLR_1_117 ( .A ( n1346 ) , .B ( n1347 ) , .Y ( tmp_net29 ) ) ;
...
CGENCONAX1H9R ctmTdsLR_1_143 ( .A ( ZBUF_54_10 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s40 [16] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_c40 [16] ) , .CON ( n1152 ) ) ;
NAND2BX0P5H9R U1343 ( .AN ( n1710 ) , .B ( n1711 ) , .Y ( n1713 ) ) ;
DLY2X0P5H9R copt_h_inst_842 ( .A ( \u_mac16_top/u_inB/shift_reg [10] ) , 
    .Y ( copt_net_68 ) ) ;
BUFX1P4H9R ZBUF_101_inst_720 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [15] ) , 
    .Y ( ZBUF_101_7 ) ) ;
XNOR2X1P4H9R ctmTdsLR_2_118 ( .A ( n859 ) , .B ( tmp_net29 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N54 ) ) ;
...
NOR2X1H9R U1359 ( .A ( n806 ) , .B ( \u_mac16_top/op_fifo_rd_ptr [1] ) , 
    .Y ( n1413 ) ) ;
OAI21X0P5H9R ctmTdsLR_1_144 ( .A0 ( n1585 ) , .A1 ( n1586 ) , .B0 ( n1587 ) , 
    .Y ( tmp_net35 ) ) ;
...
CGENX1P4H9R U1363 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [14] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [14] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s40 [14] ) , .CO ( n842 ) ) ;
NOR2X0P5H9R U1364 ( .A ( \u_mac16_top/u_mac/mult_result [11] ) , 
    .B ( \u_mac16_top/u_mac/accum_reg [11] ) , .Y ( n1045 ) ) ;
XOR2X1H9R U1365 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [8] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [8] ) , .Y ( n840 ) ) ;
...
AOI31X0P5H9R ctmTdsLR_4_65 ( .A0 ( tmp_net6 ) , .A1 ( tmp_net7 ) , 
    .A2 ( n1270 ) , .B0 ( tmp_net8 ) , .Y ( n952 ) ) ;
...
XNOR2X0P5H9R ctmTdsLR_2_145 ( .A ( tmp_net35 ) , .B ( n1288 ) , .Y ( n1290 ) ) ;
...
OAOI211X2H9R U1384 ( .A1 ( n2046 ) , .A2 ( n1875 ) , .B ( n1877 ) , 
...
DLY2X0P5H9R copt_h_inst_843 ( .A ( \u_mac16_top/u_inA/shift_reg [14] ) , 
    .Y ( copt_net_69 ) ) ;
...
AOI22X0P5H9R U1391 ( .A0 ( \u_mac16_top/u_mac/mult_result [18] ) , 
    ...
    .B1 ( n1301 ) , .Y ( n1250 ) ) ;
FREEICGX2H9R ZBUF_69_inst_722 ( .CK ( \u_mac16_top/u_mac/u_mul/r_c40 [10] ) , 
    .ECK ( ZBUF_69_7 ) ) ;
OAI21X0P5H9R U1394 ( .A0 ( n889 ) , .A1 ( n1561 ) , .B0 ( n1560 ) , 
    .Y ( n2380 ) ) ;
DLY2X0P5H9R copt_h_inst_844 ( .A ( \u_mac16_top/u_inB/shift_reg [14] ) , 
    .Y ( copt_net_70 ) ) ;
BUFX1H9R ZBUF_9_inst_724 ( .A ( n847 ) , .Y ( ZBUF_9_8 ) ) ;
FREEICGX0P5H9R copt_h_inst_845 ( .CK ( \u_mac16_top/u_inA/shift_reg [4] ) , 
    .ECK ( copt_net_71 ) ) ;
BUFX2H9R ZBUF_17_inst_727 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [12] ) , 
    .Y ( ZBUF_17_8 ) ) ;
...
FREEICGX0P5H9R copt_h_inst_846 ( .CK ( \u_mac16_top/u_inA/shift_reg [2] ) , 
    .ECK ( copt_net_72 ) ) ;
NOR2X0P5H9R U1405 ( .A ( n2206 ) , .B ( n2097 ) , .Y ( n1983 ) ) ;
INVX0P5H9R U1406 ( .A ( \u_mac16_top/opB_reg [8] ) , .Y ( n2206 ) ) ;
...
OAOI211X0P5H9R U1423 ( .A1 ( n1875 ) , .A2 ( n2044 ) , .B ( n1870 ) , 
...
BUFX1P4H9R ZBUF_17_inst_729 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [13] ) , 
    .Y ( ZBUF_17_9 ) ) ;
...
INVX1H9R U1432 ( .A ( \u_mac16_top/opA_reg [0] ) , .Y ( n2046 ) ) ;
BUFX1P7H9R ZBUF_59_inst_732 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [9] ) , 
    .Y ( ZBUF_59_10 ) ) ;
NAND2X0P5H9R U1435 ( .A ( n1653 ) , .B ( n1658 ) , .Y ( n1054 ) ) ;
BUFX1P4H9R ZBUF_35_inst_733 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [18] ) , 
    .Y ( ZBUF_35_10 ) ) ;
FREEICGX2H9R ZBUF_54_inst_734 ( .CK ( \u_mac16_top/u_mac/u_mul/r_s41 [16] ) , 
    .ECK ( ZBUF_54_10 ) ) ;
...
XOR2X0P5H9R U1445 ( .A ( \u_mac16_top/mode_reg ) , 
    .B ( \u_mac16_top/mode_reg_d1 ) , .Y ( n1361 ) ) ;
FREEICGX0P5H9R copt_h_inst_847 ( .CK ( \u_mac16_top/u_inB/shift_reg [5] ) , 
    .ECK ( copt_net_73 ) ) ;
OAI21X0P5H9R U1447 ( .A0 ( n1692 ) , .A1 ( n1646 ) , .B0 ( n1015 ) , 
    .Y ( n1650 ) ) ;
INVX1H9R U1448 ( .A ( n1013 ) , .Y ( n1692 ) ) ;
...
BUFX1P7H9R ZBUF_2_inst_797 ( .A ( \u_mac16_top/u_mac/u_mul/N50 ) , 
    .Y ( ZBUF_2_9 ) ) ;
OA21X0P5H9R U1464 ( .A0 ( n1485 ) , .A1 ( n1486 ) , .B0 ( n1561 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N40 ) ) ;
BUFX1P7H9R ZBUF_50_inst_806 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [7] ) , 
    .Y ( ZBUF_50_13 ) ) ;
...
XOR3X0P5H9R ctmTdsLR_1_824 ( .A ( n1902 ) , .B ( n1903 ) , .C ( n1904 ) , 
    .Y ( n1905 ) ) ;
...
BUFX1P7H9R ZBUF_17_inst_807 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [15] ) , 
    .Y ( ZBUF_17_13 ) ) ;
CGENX1H9R U1492 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [19] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [19] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s40 [19] ) , .CO ( n2366 ) ) ;
...
AOI21X1H9R U1498 ( .A0 ( n1524 ) , .A1 ( n848 ) , .B0 ( n1527 ) , 
    .Y ( n1350 ) ) ;
NOR2X1P4H9R U1500 ( .A ( n1361 ) , .B ( n837 ) , .Y ( n2367 ) ) ;
NOR2X0P5H9R U1502 ( .A ( n1361 ) , .B ( n837 ) , .Y ( n2368 ) ) ;
BUFX1P4H9R ZBUF_17_inst_808 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [17] ) , 
    .Y ( ZBUF_17_14 ) ) ;
ADDFX1H9R U1505 ( .A ( n2134 ) , .B ( n2133 ) , .CI ( n2132 ) , 
    .CO ( n2139 ) , .S ( n966 ) ) ;
XOR2X0P7H9R U1506 ( .A ( n2381 ) , .B ( n842 ) , .Y ( n1164 ) ) ;
OR2X0P7H9R U1507 ( .A ( n923 ) , .B ( n1547 ) , .Y ( n2369 ) ) ;
INVX0P5H9R U1508 ( .A ( n1137 ) , .Y ( n1134 ) ) ;
NAND2X0P5H9R ctmTdsLR_1_67 ( .A ( n1568 ) , .B ( n1567 ) , .Y ( tmp_net9 ) ) ;
NAND2X1H9R U1511 ( .A ( n1495 ) , .B ( n883 ) , .Y ( n886 ) ) ;
OAI211X1H9R ctmTdsLR_2_68 ( .A0 ( n1585 ) , .A1 ( n1570 ) , .B0 ( n1827 ) , 
    .C0 ( tmp_net9 ) , .Y ( n1573 ) ) ;
AOI21BX0P5H9R ctmTdsLR_1_69 ( .A0 ( n1027 ) , .A1 ( n1686 ) , .B0N ( n1685 ) , 
    .Y ( tmp_net10 ) ) ;
NAND2X0P5H9R U1514 ( .A ( n1490 ) , .B ( n1489 ) , .Y ( n1484 ) ) ;
NAND2BX0P7H9R ctmTdsLR_2_70 ( .AN ( n1671 ) , .B ( n1672 ) , .Y ( n1674 ) ) ;
FREEICGX0P5H9R copt_h_inst_848 ( .CK ( \u_mac16_top/u_inA/shift_reg [0] ) , 
    .ECK ( copt_net_74 ) ) ;
ADDFX1H9R U1520 ( .A ( n1335 ) , .B ( n1334 ) , .CI ( n1333 ) , .CO ( n965 ) , 
    .S ( n1341 ) ) ;
NAND3XXBX1H9R ctmTdsLR_1_810 ( .CN ( n1517 ) , 
    .A ( \u_mac16_top/fifo_rd_ptr [1] ) , 
    .B ( \u_mac16_top/fifo_rd_ptr [0] ) , .Y ( n2144 ) ) ;
NAND2X0P7H9R U1523 ( .A ( \u_mac16_top/u_mac/mult_result [0] ) , 
    .B ( \u_mac16_top/u_mac/last_prod [0] ) , .Y ( n1797 ) ) ;
NAND2X0P7H9R U1525 ( .A ( n1525 ) , .B ( n848 ) , .Y ( n907 ) ) ;
INVX0P7H9R U1526 ( .A ( n1342 ) , .Y ( n909 ) ) ;
XOR2X1H9R ctmTdsLR_1_811 ( .A ( tmp_net57 ) , .B ( n1137 ) , .Y ( n1175 ) ) ;
NOR2X0P5H9R U1530 ( .A ( n1646 ) , .B ( n1003 ) , .Y ( n1005 ) ) ;
AOI21X0P5H9R U1531 ( .A0 ( n1001 ) , .A1 ( n1605 ) , .B0 ( n1000 ) , 
    .Y ( n1002 ) ) ;
NOR2X1H9R U1532 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [15] ) , 
    .B ( ZBUF_190_3 ) , .Y ( n1154 ) ) ;
NAND2X1P4H9R U1533 ( .A ( n1168 ) , .B ( n1167 ) , .Y ( n879 ) ) ;
CGENCONAX1H9R ctmTdsLR_2_825 ( .A ( n1903 ) , .B ( n1904 ) , .CI ( n1902 ) , 
    .CON ( n1852 ) ) ;
OAI21X2H9R U1536 ( .A0 ( n1489 ) , .A1 ( n1169 ) , .B0 ( n879 ) , 
    .Y ( n1356 ) ) ;
NAND2X0P7H9R U1547 ( .A ( n869 ) , .B ( n1170 ) , .Y ( n1533 ) ) ;
NOR2X2H9R U1549 ( .A ( n1171 ) , .B ( n1172 ) , .Y ( n1352 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_826 ( .A ( n1922 ) , .B ( n1921 ) , .C ( n1920 ) , 
    .Y ( n1923 ) ) ;
...
CGENCONAX1H9R ctmTdsLR_2_827 ( .A ( n1922 ) , .B ( n1920 ) , .CI ( n1921 ) , 
    .CON ( n1858 ) ) ;
XOR2X0P5H9R ctmTdsLR_3_71 ( .A ( tmp_net10 ) , .B ( n1674 ) , .Y ( n1682 ) ) ;
XNOR2X0P5H9R U1570 ( .A ( n1582 ) , .B ( n1581 ) , .Y ( n1583 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_828 ( .A ( n1939 ) , .B ( n1938 ) , .C ( n1940 ) , 
    .Y ( n1941 ) ) ;
MAOI222X0P5H9R ctmTdsLR_2_829 ( .A ( n1939 ) , .B ( n1940 ) , .C ( n1938 ) , 
    .ZN ( n1864 ) ) ;
XOR3X0P5H9R ctmTdsLR_1_830 ( .A ( n1962 ) , .B ( n1963 ) , .C ( n1964 ) , 
    .Y ( n1965 ) ) ;
CGENCONAX1H9R ctmTdsLR_2_831 ( .A ( n1964 ) , .B ( n1963 ) , .CI ( n1962 ) , 
    .CON ( n1870 ) ) ;
DLY2X0P5H9R copt_h_inst_849 ( .A ( \u_mac16_top/u_inA/shift_reg [13] ) , 
    .Y ( copt_net_75 ) ) ;
INVX1H9R U1582 ( .A ( n876 ) , .Y ( n1142 ) ) ;
AOI2XB1X1P4H9R U1583 ( .A1N ( n1530 ) , .A0 ( n1532 ) , .B0 ( n2387 ) , 
    .Y ( n1536 ) ) ;
DLY2X0P5H9R copt_h_inst_850 ( .A ( \u_mac16_top/u_inB/shift_reg [7] ) , 
    .Y ( copt_net_76 ) ) ;
...
DLY2X0P5H9R copt_h_inst_851 ( .A ( \u_mac16_top/u_inA/shift_reg [8] ) , 
    .Y ( copt_net_77 ) ) ;
NOR2X0P5H9R U1595 ( .A ( n1055 ) , .B ( n1051 ) , .Y ( n980 ) ) ;
NAND2X0P5H9R ctmTdsLR_1_73 ( .A ( n1619 ) , .B ( n1643 ) , .Y ( tmp_net11 ) ) ;
DLY2X0P5H9R copt_h_inst_852 ( .A ( \u_mac16_top/u_inB/shift_reg [9] ) , 
    .Y ( copt_net_78 ) ) ;
INVX0P5H9R U1602 ( .A ( \u_mac16_top/u_mac/u_mul/r_c41 [17] ) , .Y ( n1151 ) ) ;
OAI211X0P5H9R ctmTdsLR_2_74 ( .A0 ( n1683 ) , .A1 ( n1621 ) , .B0 ( n1642 ) , 
    .C0 ( tmp_net11 ) , .Y ( n1626 ) ) ;
OAI21X0P5H9R U1606 ( .A0 ( n1045 ) , .A1 ( n1665 ) , .B0 ( n1046 ) , 
    .Y ( n998 ) ) ;
XOR2X0P5H9R U1607 ( .A ( n941 ) , .B ( n1298 ) , .Y ( n1299 ) ) ;
DLY2X0P5H9R copt_h_inst_853 ( .A ( \u_mac16_top/u_inA/shift_reg [11] ) , 
    .Y ( copt_net_79 ) ) ;
INVX0P7H9R U1609 ( .A ( n1344 ) , .Y ( n1342 ) ) ;
DLY2X0P5H9R copt_h_inst_854 ( .A ( \u_mac16_top/u_inA/shift_reg [10] ) , 
    .Y ( copt_net_80 ) ) ;
...
FREEICGX0P5H9R copt_h_inst_855 ( .CK ( \u_mac16_top/u_inB/shift_reg [6] ) , 
    .ECK ( copt_net_81 ) ) ;
XOR2X0P7H9R U1622 ( .A ( \u_mac16_top/u_mac/u_mul/r_s41 [19] ) , 
    .B ( n1136 ) , .Y ( n1133 ) ) ;
NAND2X0P5H9R ctmTdsLR_1_75 ( .A ( n1630 ) , .B ( n1648 ) , .Y ( tmp_net12 ) ) ;
NOR2X0P5H9R U1624 ( .A ( \u_mac16_top/u_mac/last_prod [7] ) , 
    .B ( \u_mac16_top/u_mac/mult_result [7] ) , .Y ( n1700 ) ) ;
...
DLY2X0P5H9R copt_h_inst_856 ( .A ( \u_mac16_top/u_inB/shift_reg [11] ) , 
    .Y ( copt_net_82 ) ) ;
FREEICGX0P5H9R copt_h_inst_857 ( .CK ( \u_mac16_top/u_inA/shift_reg [5] ) , 
    .ECK ( copt_net_83 ) ) ;
FREEICGX0P5H9R copt_h_inst_858 ( .CK ( \u_mac16_top/u_inA/shift_reg [9] ) , 
    .ECK ( copt_net_84 ) ) ;
NAND2X0P7H9R U1634 ( .A ( n909 ) , .B ( n1525 ) , .Y ( n908 ) ) ;
FREEICGX0P5H9R copt_h_inst_859 ( .CK ( \u_mac16_top/u_inA/shift_reg [1] ) , 
    .ECK ( copt_net_85 ) ) ;
...
FREEICGX0P5H9R copt_h_inst_860 ( .CK ( \u_mac16_top/u_inB/shift_reg [8] ) , 
    .ECK ( copt_net_86 ) ) ;
XNOR2X0P7H9R U1647 ( .A ( n1128 ) , .B ( n1129 ) , .Y ( n1496 ) ) ;
NOR2X2H9R U1653 ( .A ( n1170 ) , .B ( n869 ) , .Y ( n1355 ) ) ;
OAI21X0P7H9R U1655 ( .A0 ( n1762 ) , .A1 ( n1776 ) , .B0 ( n1763 ) , 
    .Y ( n973 ) ) ;
...
XOR2X0P7H9R U1662 ( .A ( n1117 ) , .B ( ZBUF_69_7 ) , .Y ( n1122 ) ) ;
...
NOR2X1P4H9R U1666 ( .A ( n1517 ) , .B ( n1074 ) , .Y ( n2147 ) ) ;
NOR2X1P4H9R U1667 ( .A ( n1517 ) , .B ( n1075 ) , .Y ( n2148 ) ) ;
...
FREEICGX0P5H9R copt_h_inst_861 ( .CK ( \u_mac16_top/u_inA/shift_reg [3] ) , 
    .ECK ( copt_net_87 ) ) ;
INVX0P5H9R U1707 ( .A ( n2145 ) , .Y ( n2190 ) ) ;
OAI211X0P5H9R ctmTdsLR_2_76 ( .A0 ( n1692 ) , .A1 ( n1632 ) , .B0 ( n1647 ) , 
    .C0 ( tmp_net12 ) , .Y ( n1637 ) ) ;
INVX1P4H9R U1709 ( .A ( \u_mac16_top/opA_reg [4] ) , .Y ( n2057 ) ) ;
INVX1H9R U1710 ( .A ( \u_mac16_top/opA_reg [3] ) , .Y ( n2059 ) ) ;
...
FREEICGX0P5H9R copt_h_inst_862 ( .CK ( \u_mac16_top/u_inA/shift_reg [12] ) , 
    .ECK ( copt_net_88 ) ) ;
...
FREEICGX0P5H9R copt_h_inst_863 ( .CK ( \u_mac16_top/u_inB/shift_reg [12] ) , 
    .ECK ( copt_net_89 ) ) ;
...
INVX0P7H9R U1741 ( .A ( \u_mac16_top/opB_reg [7] ) , .Y ( n2045 ) ) ;
NOR2X0P5H9R U1742 ( .A ( n2045 ) , .B ( n2044 ) , .Y ( n2056 ) ) ;
INVX0P7H9R U1743 ( .A ( \u_mac16_top/opB_reg [13] ) , .Y ( n1882 ) ) ;
NOR2X0P5H9R U1744 ( .A ( n2044 ) , .B ( n1948 ) , .Y ( n2216 ) ) ;
DLY2X0P5H9R copt_h_inst_864 ( .A ( \u_mac16_top/u_inB/shift_reg [13] ) , 
    .Y ( copt_net_90 ) ) ;
FREEICGX0P5H9R copt_h_inst_865 ( .CK ( \u_mac16_top/u_inA/shift_reg [7] ) , 
    .ECK ( copt_net_91 ) ) ;
...
NAND2XBX0P5H9R ctmTdsLR_1_77 ( .BN ( n889 ) , .A ( n1560 ) , .Y ( n1562 ) ) ;
...
FREEICGX0P5H9R copt_h_inst_866 ( .CK ( \u_mac16_top/u_inA/shift_reg [6] ) , 
    .ECK ( copt_net_92 ) ) ;
FREEICGX0P5H9R copt_h_inst_867 ( .CK ( \u_mac16_top/u_mac/mult_result [18] ) , 
    .ECK ( copt_net_93 ) ) ;
...
INVX1H9R U1767 ( .A ( \u_mac16_top/opA_reg [6] ) , .Y ( n2119 ) ) ;
INVX1H9R U1768 ( .A ( \u_mac16_top/opA_reg [5] ) , .Y ( n2121 ) ) ;
INVX0P5H9R U1770 ( .A ( n1859 ) , .Y ( n1861 ) ) ;
INVX0P5H9R U1772 ( .A ( n1865 ) , .Y ( n1867 ) ) ;
...
NOR2XBX0P5H9R ctmTdsLR_1_78 ( .BN ( n2363 ) , .A ( n1497 ) , .Y ( n1498 ) ) ;
OAI21X0P5H9R ctmTdsLR_1_79 ( .A0 ( \u_mac16_top/u_inB/cnt [0] ) , 
    .A1 ( \u_mac16_top/u_inB/cnt [1] ) , .B0 ( n1804 ) , .Y ( tmp_net13 ) ) ;
...
AOI21X0P5H9R U1799 ( .A0 ( n1630 ) , .A1 ( n1606 ) , .B0 ( n1605 ) , 
    .Y ( n1607 ) ) ;
TIELOX1H9R optlc_880 ( .Y ( optlc_net_99 ) ) ;
NAND2X0P5H9R U1801 ( .A ( n1565 ) , .B ( n1567 ) , .Y ( n1570 ) ) ;
NOR2X0P5H9R ctmTdsLR_2_80 ( .A ( n1802 ) , .B ( tmp_net13 ) , 
...
BUFX2H9R U1809 ( .A ( \u_mac16_top/u_out/busy ) , .Y ( n926 ) ) ;
NAND2X0P5H9R ctmTdsLR_1_81 ( .A ( n1662 ) , .B ( n1666 ) , .Y ( tmp_net14 ) ) ;
...
AOI22X0P5H9R U1840 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][3] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][3] ) , .Y ( n1444 ) ) ;
...
AOI22X0P5H9R U1844 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][1] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][1] ) , .Y ( n1388 ) ) ;
...
AOI22X0P5H9R U1847 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][0] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][0] ) , .Y ( n1412 ) ) ;
...
AOI22X0P5H9R U1852 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][2] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][2] ) , .Y ( n1423 ) ) ;
NAND2X0P7H9R U1853 ( .A ( n1420 ) , .B ( n1419 ) , .Y ( n777 ) ) ;
AOI22X0P5H9R U1854 ( .A0 ( n1452 ) , .A1 ( \u_mac16_top/opB_fifo[3][4] ) , 
    .B0 ( n1421 ) , .B1 ( \u_mac16_top/opB_fifo[0][4] ) , .Y ( n1419 ) ) ;
AOI22X0P5H9R U1855 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][4] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][4] ) , .Y ( n1420 ) ) ;
NAND2X0P5H9R U1856 ( .A ( n1382 ) , .B ( n1381 ) , .Y ( n803 ) ) ;
AOI22X0P5H9R U1857 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opA_fifo[2][14] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opA_fifo[1][14] ) , .Y ( n1382 ) ) ;
...
AOI22X0P5H9R U1862 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][15] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opA_fifo[1][15] ) , .Y ( n1448 ) ) ;
...
TIELOX1H9R optlc_881 ( .Y ( optlc_net_100 ) ) ;
...
OAI211X0P5H9R ctmTdsLR_2_82 ( .A0 ( n1692 ) , .A1 ( n1044 ) , .B0 ( n1665 ) , 
    .C0 ( tmp_net14 ) , .Y ( n1049 ) ) ;
TIELOX1H9R optlc_882 ( .Y ( optlc_net_101 ) ) ;
NAND2X0P5H9R U1891 ( .A ( n1031 ) , .B ( n1617 ) , .Y ( n1033 ) ) ;
...
TIELOX1H9R optlc_883 ( .Y ( optlc_net_102 ) ) ;
...
INVX0P5H9R U1928 ( .A ( n1853 ) , .Y ( n1855 ) ) ;
...
NAND2XBX0P7H9R ctmTdsLR_1_84 ( .BN ( n1527 ) , .A ( n848 ) , 
    .Y ( tmp_net15 ) ) ;
FREEICGX0P5H9R U2133 ( .CK ( n2213 ) , .ECK ( n1440 ) ) ;
FREEICGX0P7H9R U2135 ( .CK ( n2213 ) , .ECK ( n1450 ) ) ;
FREEICGX0P6H9R U2136 ( .CK ( n1416 ) , .ECK ( n1442 ) ) ;
XOR2X2H9R ctmTdsLR_2_85 ( .A ( n1529 ) , .B ( tmp_net15 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N52 ) ) ;
...
AOI22X0P5H9R U2152 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][8] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][8] ) , .Y ( n1425 ) ) ;
...
AOI22X0P5H9R U2155 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][5] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][5] ) , .Y ( n1427 ) ) ;
NAND2X0P5H9R U2156 ( .A ( n1384 ) , .B ( n1383 ) , .Y ( n801 ) ) ;
AOI22X0P5H9R U2157 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opA_fifo[2][12] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opA_fifo[1][12] ) , .Y ( n1384 ) ) ;
...
AOI22X0P5H9R U2162 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][8] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opA_fifo[1][8] ) , .Y ( n1446 ) ) ;
...
AOI22X0P5H9R U2167 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][12] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opB_fifo[1][12] ) , .Y ( n1390 ) ) ;
...
AOI22X0P5H9R U2170 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][3] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][3] ) , .Y ( n1404 ) ) ;
...
AOI22X0P5H9R U2173 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][5] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][5] ) , .Y ( n1392 ) ) ;
NAND2X0P5H9R U2177 ( .A ( gre_a_INV_23_14 ) , .B ( n1477 ) , .Y ( n1541 ) ) ;
NAND2X0P5H9R U2178 ( .A ( n1538 ) , .B ( n2369 ) , .Y ( n1542 ) ) ;
...
AOI22X0P5H9R U2189 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][6] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][6] ) , .Y ( n1402 ) ) ;
...
AOI22X0P5H9R U2194 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][13] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][13] ) , .Y ( n1398 ) ) ;
...
AOI22X0P5H9R U2197 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opB_fifo[2][13] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opB_fifo[1][13] ) , .Y ( n1408 ) ) ;
...
AOI22X0P5H9R U2203 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][11] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opA_fifo[1][11] ) , .Y ( n1454 ) ) ;
...
AOI22X0P5H9R U2210 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][11] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][11] ) , .Y ( n1435 ) ) ;
NAND2X0P5H9R U2211 ( .A ( n1380 ) , .B ( n1379 ) , .Y ( n799 ) ) ;
AOI22X0P5H9R U2212 ( .A0 ( n2213 ) , .A1 ( \u_mac16_top/opA_fifo[2][10] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opA_fifo[1][10] ) , .Y ( n1380 ) ) ;
...
AOI22X0P5H9R U2217 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][9] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][9] ) , .Y ( n1394 ) ) ;
...
AOI22X0P5H9R U2225 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][10] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][10] ) , .Y ( n1433 ) ) ;
...
AOI22X0P5H9R U2228 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][9] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][9] ) , .Y ( n1431 ) ) ;
...
AOI22X0P5H9R U2231 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][4] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][4] ) , .Y ( n1396 ) ) ;
...
AOI22X0P5H9R U2240 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][7] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][7] ) , .Y ( n1400 ) ) ;
...
AOI22X0P5H9R U2243 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opA_fifo[2][2] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opA_fifo[1][2] ) , .Y ( n1410 ) ) ;
...
AOI22X0P5H9R U2246 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][6] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][6] ) , .Y ( n1429 ) ) ;
...
AOI22X0P5H9R U2250 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][0] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][0] ) , .Y ( n1437 ) ) ;
...
AOI22X0P5H9R U2255 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][7] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][7] ) , .Y ( n1439 ) ) ;
...
NAND2XBX0P7H9R ctmTdsLR_1_86 ( .BN ( n1352 ) , .A ( n1353 ) , 
    .Y ( tmp_net16 ) ) ;
...
AOI22X0P5H9R U2331 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opB_fifo[2][15] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opB_fifo[1][15] ) , .Y ( n1406 ) ) ;
NAND2X0P5H9R U2334 ( .A ( \u_mac16_top/opB_reg [15] ) , 
    .B ( \u_mac16_top/opA_reg [8] ) , .Y ( n1457 ) ) ;
AOI21X0P5H9R U2337 ( .A0 ( n1852 ) , .A1 ( n1851 ) , 
...
AOI21X0P5H9R U2350 ( .A0 ( n1864 ) , .A1 ( n1863 ) , 
...
AOI21X0P5H9R U2357 ( .A0 ( n1867 ) , .A1 ( n1866 ) , 
...
NOR3X0P5H9R U2365 ( .A ( n1875 ) , .B ( n1855 ) , .C ( n2119 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/st2_3/gen_csa_fa[21].u_fa/N1 ) ) ;
NOR3X0P5H9R U2366 ( .A ( n1875 ) , .B ( n1858 ) , .C ( n2121 ) , 
...
NOR3X0P5H9R U2442 ( .A ( n2044 ) , .B ( n1875 ) , .C ( n1870 ) , 
...
AOI22X0P5H9R U2599 ( .A0 ( n1440 ) , .A1 ( \u_mac16_top/opB_fifo[2][1] ) , 
    .B0 ( n2212 ) , .B1 ( \u_mac16_top/opB_fifo[1][1] ) , .Y ( n1418 ) ) ;
...
AOI22X0P5H9R U2626 ( .A0 ( n1450 ) , .A1 ( \u_mac16_top/opB_fifo[2][14] ) , 
    .B0 ( n1413 ) , .B1 ( \u_mac16_top/opB_fifo[1][14] ) , .Y ( n1415 ) ) ;
...
DFFRPQX0P5H9R \u_mac16_top/mac_result_shadow_reg[19] ( 
    .D ( \u_mac16_top/N111 ) , .CK ( \u_mac16_top/net622 ) , 
    .R ( HFSNET_24 ) , .Q ( \u_mac16_top/mac_result_shadow [19] ) ) ;
NAND2X1P4H9R U1121 ( .A ( n1527 ) , .B ( n876 ) , .Y ( n1207 ) ) ;
NOR2X0P7H9R U1120 ( .A ( n1189 ) , .B ( n1207 ) , .Y ( n1191 ) ) ;
NAND2X0P5H9R U1135 ( .A ( n1182 ) , .B ( n1183 ) , .Y ( n1212 ) ) ;
...
OAI211X1H9R U2308 ( .A0 ( n1189 ) , .A1 ( n1349 ) , .B0 ( n1213 ) , 
    .C0 ( n1188 ) , .Y ( n1190 ) ) ;
NOR2X0P5H9R U1116 ( .A ( n1190 ) , .B ( n1191 ) , .Y ( n863 ) ) ;
NOR2X1H9R U1112 ( .A ( n1342 ) , .B ( n1189 ) , .Y ( n1192 ) ) ;
NAND3X0P7H9R U1111 ( .A ( n1532 ) , .B ( n1192 ) , .C ( n1525 ) , 
    .Y ( n862 ) ) ;
NAND3X2H9R U1109 ( .A ( n862 ) , .B ( n863 ) , .C ( n846 ) , .Y ( n860 ) ) ;
...
CGENCONAX1H9R U2297 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [21] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [21] ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_s40 [21] ) , .CON ( n1193 ) ) ;
INVX0P5H9R U1706 ( .A ( n1193 ) , .Y ( n1195 ) ) ;
CGENCONAX1H9R U2309 ( .A ( \u_mac16_top/u_mac/u_mul/r_c41 [22] ) , 
    .B ( n1195 ) , .CI ( n1194 ) , .CON ( n1199 ) ) ;
XNOR3X0P5H9R U1106 ( .A ( n1199 ) , .B ( n1198 ) , .C ( n1197 ) , 
    .Y ( n1200 ) ) ;
XOR2X1P4H9R U1102 ( .A ( n860 ) , .B ( n1200 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N56 ) ) ;
NAND2X0P7H9R U1085 ( .A ( n1132 ) , .B ( n1131 ) , .Y ( n1477 ) ) ;
XNOR2X2H9R ctmTdsLR_2_87 ( .A ( n861 ) , .B ( tmp_net16 ) , 
    .Y ( \u_mac16_top/u_mac/u_mul/N51 ) ) ;
NOR2X1H9R U1142 ( .A ( n923 ) , .B ( n1547 ) , .Y ( n1478 ) ) ;
AOI21X2H9R U1353 ( .A0 ( n1478 ) , .A1 ( n921 ) , .B0 ( n865 ) , .Y ( n920 ) ) ;
NAND2X1P4H9R U1097 ( .A ( n883 ) , .B ( n1547 ) , .Y ( n1546 ) ) ;
NOR2X1P4H9R U1076 ( .A ( n1132 ) , .B ( n1131 ) , .Y ( n1476 ) ) ;
NAND2X2H9R U1134 ( .A ( n890 ) , .B ( n1552 ) , .Y ( n872 ) ) ;
NAND2X3H9R U1086 ( .A ( n919 ) , .B ( n920 ) , .Y ( n1532 ) ) ;
NOR2X1P4H9R U1571 ( .A ( n1553 ) , .B ( n1551 ) , .Y ( n890 ) ) ;
NOR2X2H9R U1648 ( .A ( n899 ) , .B ( n1108 ) , .Y ( n1118 ) ) ;
NAND2X1H9R U1126 ( .A ( n872 ) , .B ( n873 ) , .Y ( n2354 ) ) ;
NAND2X1P4H9R U1088 ( .A ( n872 ) , .B ( n873 ) , .Y ( n1545 ) ) ;
NAND2X0P7H9R U1581 ( .A ( n1122 ) , .B ( n1118 ) , .Y ( n1554 ) ) ;
NAND2X1P4H9R U1603 ( .A ( n891 ) , .B ( n1116 ) , .Y ( n1550 ) ) ;
NOR2X1H9R U1748 ( .A ( n887 ) , .B ( n1118 ) , .Y ( n1553 ) ) ;
XOR2X1H9R U1237 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [10] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s41 [10] ) , .Y ( n1117 ) ) ;
NAND2X1H9R U1150 ( .A ( n856 ) , .B ( ZBUF_69_7 ) , .Y ( n906 ) ) ;
OAI21X1P4H9R U1605 ( .A0 ( n1111 ) , .A1 ( ZBUF_69_7 ) , .B0 ( n906 ) , 
    .Y ( n858 ) ) ;
XOR2X0P7H9R U1258 ( .A ( n858 ) , .B ( n1117 ) , .Y ( n887 ) ) ;
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[23] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N56 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[12] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N45 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[4] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N37 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
    .Q ( \u_mac16_top/u_mac/mult_result [4] ) ) ;
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[5] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N38 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
    .Q ( \u_mac16_top/u_mac/mult_result [5] ) ) ;
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[22] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N55 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
...
DFFRPQX1H9R \u_mac16_top/u_mac/u_mul/r_s41_reg[10] ( 
...
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[20] ( 
    .D ( ZBUF_2_10 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
    .Q ( \u_mac16_top/u_mac/mult_result [20] ) ) ;
DFFRPQX0P5H9R \u_mac16_top/u_mac/u_mul/product_reg_reg[21] ( 
    .D ( \u_mac16_top/u_mac/u_mul/N54 ) , .CK ( clk ) , .R ( HFSNET_32 ) , 
...
MAOI222X0P5H9R U1051 ( .A ( \u_mac16_top/u_mac/u_mul/r_s31 [12] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c30 [12] ) , 
...
INVX2H9R U1061 ( .A ( n1532 ) , .Y ( n847 ) ) ;
NOR2X1P4H9R U1062 ( .A ( n1130 ) , .B ( n902 ) , .Y ( n2385 ) ) ;
NOR2X1H9R U1065 ( .A ( n1130 ) , .B ( n902 ) , .Y ( n1480 ) ) ;
NAND2X2H9R U1075 ( .A ( ZBUF_59_10 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s40 [9] ) , .Y ( n1111 ) ) ;
NOR2X0P7H9R U1081 ( .A ( n1881 ) , .B ( n2107 ) , .Y ( n1913 ) ) ;
INVX0P5H9R U1087 ( .A ( \u_mac16_top/opB_reg [12] ) , .Y ( n1881 ) ) ;
OAI21X0P5H9R U1090 ( .A0 ( n1252 ) , .A1 ( n1304 ) , .B0 ( n1253 ) , 
    .Y ( n987 ) ) ;
CGENX1P4H9R U1094 ( .A ( \u_mac16_top/u_mac/u_mul/r_c40 [17] ) , 
    .B ( ZBUF_17_14 ) , .CI ( \u_mac16_top/u_mac/u_mul/r_s41 [17] ) , 
    .CO ( n2365 ) ) ;
OAI21X1H9R U1098 ( .A0 ( n1533 ) , .A1 ( n1352 ) , .B0 ( n1353 ) , 
    .Y ( n1173 ) ) ;
...
OAI21X0P5H9R U1114 ( .A0 ( n1489 ) , .A1 ( n1169 ) , .B0 ( n879 ) , 
    .Y ( n2387 ) ) ;
NAND2X1H9R U1128 ( .A ( n841 ) , .B ( n1165 ) , .Y ( n1168 ) ) ;
NAND2X1H9R U1146 ( .A ( n1164 ) , .B ( n1163 ) , .Y ( n1489 ) ) ;
NOR2X1H9R U1148 ( .A ( n1563 ) , .B ( n1564 ) , .Y ( n1485 ) ) ;
XNOR2X0P7H9R U1152 ( .A ( \u_mac16_top/u_mac/u_mul/r_s40 [6] ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [6] ) , .Y ( n1563 ) ) ;
NOR2X0P5H9R U1155 ( .A ( \u_mac16_top/u_mac/mult_result [5] ) , 
...
INVX1P7H9R U1179 ( .A ( n1209 ) , .Y ( n1524 ) ) ;
NAND2X0P5H9R U1181 ( .A ( n1496 ) , .B ( n1495 ) , .Y ( n1494 ) ) ;
NOR2X0P7H9R U1188 ( .A ( \u_mac16_top/u_mac/mult_result [4] ) , 
    .B ( \u_mac16_top/u_mac/accum_reg [4] ) , .Y ( n1740 ) ) ;
NAND2X0P7H9R U1189 ( .A ( ZBUF_59_10 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_s40 [9] ) , .Y ( n856 ) ) ;
XNOR2X2H9R U1193 ( .A ( n1127 ) , .B ( n1126 ) , .Y ( n1547 ) ) ;
NOR2X0P5H9R U1196 ( .A ( n1480 ) , .B ( n1476 ) , .Y ( n921 ) ) ;
OAI21X0P7H9R U1198 ( .A0 ( n2385 ) , .A1 ( n1477 ) , .B0 ( n922 ) , 
    .Y ( n865 ) ) ;
NAND2X0P7H9R U1201 ( .A ( n902 ) , .B ( n1130 ) , .Y ( n922 ) ) ;
NAND2X0P5H9R U1207 ( .A ( n1192 ) , .B ( n1524 ) , .Y ( n846 ) ) ;
...
OAI211X0P5H9R U1224 ( .A0 ( n2144 ) , .A1 ( n2188 ) , .B0 ( n2186 ) , 
    .C0 ( n2187 ) , .Y ( \u_mac16_top/N103 ) ) ;
OAI211X0P5H9R U1225 ( .A0 ( n2144 ) , .A1 ( n2175 ) , .B0 ( n2173 ) , 
    .C0 ( n2174 ) , .Y ( \u_mac16_top/N100 ) ) ;
OAI211X0P5H9R U1226 ( .A0 ( n2144 ) , .A1 ( n2166 ) , .B0 ( n2165 ) , 
    .C0 ( n2164 ) , .Y ( \u_mac16_top/N97 ) ) ;
AOI21X0P5H9R U1247 ( .A0 ( n1007 ) , .A1 ( n1293 ) , .B0 ( n1006 ) , 
    .Y ( n1820 ) ) ;
XOR2X0P7H9R U1250 ( .A ( n1158 ) , .B ( ZBUF_101_7 ) , .Y ( n912 ) ) ;
NOR2X1H9R U1252 ( .A ( n1162 ) , .B ( n1161 ) , .Y ( n1163 ) ) ;
NAND2X0P7H9R U1267 ( .A ( n1490 ) , .B ( n1532 ) , .Y ( n851 ) ) ;
AOI21X0P5H9R U1268 ( .A0 ( n999 ) , .A1 ( n1662 ) , .B0 ( n998 ) , 
    .Y ( n1015 ) ) ;
OAI21X0P5H9R U1269 ( .A0 ( n1676 ) , .A1 ( n1689 ) , .B0 ( n1677 ) , 
    .Y ( n1662 ) ) ;
NOR2X1P4H9R U1270 ( .A ( n1355 ) , .B ( n1352 ) , .Y ( n1174 ) ) ;
...
OAI21X1H9R U1308 ( .A0 ( n1695 ) , .A1 ( n978 ) , .B0 ( n977 ) , 
    .Y ( n1027 ) ) ;
NAND2X0P7H9R U1340 ( .A ( n1343 ) , .B ( n1347 ) , .Y ( n1208 ) ) ;
...
NAND2X2H9R U1562 ( .A ( ZBUF_50_13 ) , 
    .B ( \u_mac16_top/u_mac/u_mul/r_c40 [7] ) , .Y ( n1113 ) ) ;
AOI21X0P5H9R U1563 ( .A0 ( n974 ) , .A1 ( n1761 ) , .B0 ( n973 ) , 
    .Y ( n1695 ) ) ;
XOR2X1H9R U1597 ( .A ( n840 ) , .B ( n1113 ) , .Y ( n1114 ) ) ;
NOR2X0P5H9R U1598 ( .A ( n1633 ) , .B ( n1627 ) , .Y ( n1606 ) ) ;
NOR2X0P5H9R U1601 ( .A ( \u_mac16_top/u_mac/mult_result [12] ) , 
...
OAI21X0P5H9R U1654 ( .A0 ( n1285 ) , .A1 ( n1587 ) , .B0 ( n1286 ) , 
    .Y ( n1301 ) ) ;
CGENCONAX1H9R U1658 ( .A ( ZBUF_101_7 ) , .B ( ZBUF_17_13 ) , 
    .CI ( \u_mac16_top/u_mac/u_mul/r_c40 [15] ) , .CON ( n1157 ) ) ;
NAND2X0P5H9R U1664 ( .A ( n912 ) , .B ( ZBUF_190_3 ) , .Y ( n1165 ) ) ;
...
NOR2X1H9R U1879 ( .A ( n1719 ) , .B ( n1700 ) , .Y ( n976 ) ) ;
...
NAND2X1P4H9R U2062 ( .A ( n1207 ) , .B ( n1349 ) , .Y ( n1343 ) ) ;
NAND2X1H9R U2164 ( .A ( n1128 ) , .B ( n1129 ) , .Y ( n883 ) ) ;
NAND2X1P4H9R U2183 ( .A ( n1486 ) , .B ( n1485 ) , .Y ( n1561 ) ) ;
